...
00000000 <thread2>:
      ...
      ac:	00001958 	.word	0x00001958
      b0:	0000196c 	.word	0x0000196c
...
000000b4 <main>:
     ...
     178:	eb000447 	bl	129c <printf>
     17c:	eb0002a4 	bl	c14 <exit>
     180:	00001988 	.word	0x00001988
     184:	00000000 	.word	0x00000000
     188:	00001998 	.word	0x00001998
...
0000112c <putc>:
    112c:	e92d4800 	push	{fp, lr}
    1130:	e28db004 	add	fp, sp, #4
    1134:	e24dd008 	sub	sp, sp, #8
    1138:	e50b0008 	str	r0, [fp, #-8]
    113c:	e1a03001 	mov	r3, r1
    1140:	e54b3009 	strb	r3, [fp, #-9]
    1144:	e24b3009 	sub	r3, fp, #9
    1148:	e3a02001 	mov	r2, #1
    114c:	e1a01003 	mov	r1, r3
    1150:	e51b0008 	ldr	r0, [fp, #-8]
    1154:	ebfffed2 	bl	ca4 <write>
    1158:	e1a00000 	nop			@ (mov r0, r0)
    115c:	e24bd004 	sub	sp, fp, #4
    1160:	e8bd8800 	pop	{fp, pc}

00001164 <printint>:
    1164:	e92d4800 	push	{fp, lr}
    1168:	e28db004 	add	fp, sp, #4
    116c:	e24dd030 	sub	sp, sp, #48	@ 0x30
    1170:	e50b0028 	str	r0, [fp, #-40]	@ 0xffffffd8
    1174:	e50b102c 	str	r1, [fp, #-44]	@ 0xffffffd4
    1178:	e50b2030 	str	r2, [fp, #-48]	@ 0xffffffd0
    117c:	e50b3034 	str	r3, [fp, #-52]	@ 0xffffffcc
    1180:	e3a03000 	mov	r3, #0
    1184:	e50b300c 	str	r3, [fp, #-12]
    1188:	e51b3034 	ldr	r3, [fp, #-52]	@ 0xffffffcc
    118c:	e3530000 	cmp	r3, #0
    1190:	0a000008 	beq	11b8 <printint+0x54>
    1194:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    1198:	e3530000 	cmp	r3, #0
    119c:	aa000005 	bge	11b8 <printint+0x54>
    11a0:	e3a03001 	mov	r3, #1
    11a4:	e50b300c 	str	r3, [fp, #-12]
    11a8:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    11ac:	e2633000 	rsb	r3, r3, #0
    11b0:	e50b3010 	str	r3, [fp, #-16]
    11b4:	ea000001 	b	11c0 <printint+0x5c>
    11b8:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    11bc:	e50b3010 	str	r3, [fp, #-16]
    11c0:	e3a03000 	mov	r3, #0
    11c4:	e50b3008 	str	r3, [fp, #-8]
    11c8:	e51b2030 	ldr	r2, [fp, #-48]	@ 0xffffffd0
    11cc:	e51b3010 	ldr	r3, [fp, #-16]
    11d0:	e1a01002 	mov	r1, r2
    11d4:	e1a00003 	mov	r0, r3
    11d8:	eb0001d5 	bl	1934 <__aeabi_uidivmod>
    11dc:	e1a03001 	mov	r3, r1
    11e0:	e1a01003 	mov	r1, r3
    11e4:	e51b3008 	ldr	r3, [fp, #-8]
    11e8:	e2832001 	add	r2, r3, #1
    11ec:	e50b2008 	str	r2, [fp, #-8]
    11f0:	e59f20a0 	ldr	r2, [pc, #160]	@ 1298 <printint+0x134>
    11f4:	e7d22001 	ldrb	r2, [r2, r1]
    11f8:	e2433004 	sub	r3, r3, #4
    11fc:	e083300b 	add	r3, r3, fp
    1200:	e543201c 	strb	r2, [r3, #-28]	@ 0xffffffe4
    1204:	e51b3030 	ldr	r3, [fp, #-48]	@ 0xffffffd0
    1208:	e1a01003 	mov	r1, r3
    120c:	e51b0010 	ldr	r0, [fp, #-16]
    1210:	eb00018a 	bl	1840 <__udivsi3>
    1214:	e1a03000 	mov	r3, r0
    1218:	e50b3010 	str	r3, [fp, #-16]
    121c:	e51b3010 	ldr	r3, [fp, #-16]
    1220:	e3530000 	cmp	r3, #0
    1224:	1affffe7 	bne	11c8 <printint+0x64>
    1228:	e51b300c 	ldr	r3, [fp, #-12]
    122c:	e3530000 	cmp	r3, #0
    1230:	0a00000e 	beq	1270 <printint+0x10c>
    1234:	e51b3008 	ldr	r3, [fp, #-8]
    1238:	e2832001 	add	r2, r3, #1
    123c:	e50b2008 	str	r2, [fp, #-8]
    1240:	e2433004 	sub	r3, r3, #4
    1244:	e083300b 	add	r3, r3, fp
    1248:	e3a0202d 	mov	r2, #45	@ 0x2d
    124c:	e543201c 	strb	r2, [r3, #-28]	@ 0xffffffe4
    1250:	ea000006 	b	1270 <printint+0x10c>
    1254:	e24b2020 	sub	r2, fp, #32
    1258:	e51b3008 	ldr	r3, [fp, #-8]
    125c:	e0823003 	add	r3, r2, r3
    1260:	e5d33000 	ldrb	r3, [r3]
    1264:	e1a01003 	mov	r1, r3
    1268:	e51b0028 	ldr	r0, [fp, #-40]	@ 0xffffffd8
    126c:	ebffffae 	bl	112c <putc>
    ...
    1284:	aafffff2 	bge	1254 <printint+0xf0>
    1288:	e1a00000 	nop			@ (mov r0, r0)
    128c:	e1a00000 	nop			@ (mov r0, r0)
    1290:	e24bd004 	sub	sp, fp, #4
    1294:	e8bd8800 	pop	{fp, pc}
    1298:	000019b4 	.word	0x000019b4

0000129c <printf>:
    129c:	e92d000e 	push	{r1, r2, r3}
    12a0:	e92d4800 	push	{fp, lr}
    12a4:	e28db004 	add	fp, sp, #4
    12a8:	e24dd024 	sub	sp, sp, #36	@ 0x24
    12ac:	e50b0024 	str	r0, [fp, #-36]	@ 0xffffffdc
    12b0:	e3a03000 	mov	r3, #0
    12b4:	e50b3014 	str	r3, [fp, #-20]	@ 0xffffffec
    12b8:	e28b3008 	add	r3, fp, #8
    12bc:	e50b3018 	str	r3, [fp, #-24]	@ 0xffffffe8
    12c0:	e3a03000 	mov	r3, #0
    12c4:	e50b3010 	str	r3, [fp, #-16]
    12c8:	ea000074 	b	14a0 <printf+0x204>
    12cc:	e59b2004 	ldr	r2, [fp, #4]
    12d0:	e51b3010 	ldr	r3, [fp, #-16]
    12d4:	e0823003 	add	r3, r2, r3
    12d8:	e5d33000 	ldrb	r3, [r3]
    12dc:	e50b301c 	str	r3, [fp, #-28]	@ 0xffffffe4
    12e0:	e51b3014 	ldr	r3, [fp, #-20]	@ 0xffffffec
    12e4:	e3530000 	cmp	r3, #0
    12e8:	1a00000b 	bne	131c <printf+0x80>
    12ec:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    12f0:	e3530025 	cmp	r3, #37	@ 0x25
    12f4:	1a000002 	bne	1304 <printf+0x68>
    12f8:	e3a03025 	mov	r3, #37	@ 0x25
    12fc:	e50b3014 	str	r3, [fp, #-20]	@ 0xffffffec
    1300:	ea000063 	b	1494 <printf+0x1f8>
    ...
    1314:	ebffff84 	bl	112c <putc>
    1318:	ea00005d 	b	1494 <printf+0x1f8>
    131c:	e51b3014 	ldr	r3, [fp, #-20]	@ 0xffffffec
    1320:	e3530025 	cmp	r3, #37	@ 0x25
    1324:	1a00005a 	bne	1494 <printf+0x1f8>
    1328:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    132c:	e3530064 	cmp	r3, #100	@ 0x64
    1330:	1a00000a 	bne	1360 <printf+0xc4>
    ...
    13d0:	1a00000a 	bne	1400 <printf+0x164>
    13d4:	e59f30f4 	ldr	r3, [pc, #244]	@ 14d0 <printf+0x234>
    13d8:	e50b300c 	str	r3, [fp, #-12]
    13dc:	ea000007 	b	1400 <printf+0x164>
    13e0:	e51b300c 	ldr	r3, [fp, #-12]
    13e4:	e5d33000 	ldrb	r3, [r3]
    13e8:	e1a01003 	mov	r1, r3
    13ec:	e51b0024 	ldr	r0, [fp, #-36]	@ 0xffffffdc
    13f0:	ebffff4d 	bl	112c <putc>
    ...
    140c:	1afffff3 	bne	13e0 <printf+0x144>
    1410:	ea00001d 	b	148c <printf+0x1f0>
    1414:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    1418:	e3530063 	cmp	r3, #99	@ 0x63
    141c:	1a000009 	bne	1448 <printf+0x1ac>
...
00001650 <morecore>:
    ...
    16b4:	e2833008 	add	r3, r3, #8
    16b8:	e1a00003 	mov	r0, r3
    16bc:	ebffff84 	bl	14d4 <free>
    16c0:	e59f300c 	ldr	r3, [pc, #12]	@ 16d4 <morecore+0x84>
    16c4:	e5933000 	ldr	r3, [r3]
    16c8:	e1a00003 	mov	r0, r3
    16cc:	e24bd004 	sub	sp, fp, #4
    16d0:	e8bd8800 	pop	{fp, pc}
    16d4:	000019d0 	.word	0x000019d0

000016d8 <malloc>:
    16d8:	e92d4800 	push	{fp, lr}
    16dc:	e28db004 	add	fp, sp, #4
    16e0:	e24dd018 	sub	sp, sp, #24
    16e4:	e50b0018 	str	r0, [fp, #-24]	@ 0xffffffe8
    16e8:	e51b3018 	ldr	r3, [fp, #-24]	@ 0xffffffe8
    16ec:	e2833007 	add	r3, r3, #7
    16f0:	e1a031a3 	lsr	r3, r3, #3
    16f4:	e2833001 	add	r3, r3, #1
    16f8:	e50b3010 	str	r3, [fp, #-16]
    16fc:	e59f3134 	ldr	r3, [pc, #308]	@ 1838 <malloc+0x160>
    1700:	e5933000 	ldr	r3, [r3]
    1704:	e50b300c 	str	r3, [fp, #-12]
    1708:	e51b300c 	ldr	r3, [fp, #-12]
    170c:	e3530000 	cmp	r3, #0
    1710:	1a00000b 	bne	1744 <malloc+0x6c>
    1714:	e59f3120 	ldr	r3, [pc, #288]	@ 183c <malloc+0x164>
    1718:	e50b300c 	str	r3, [fp, #-12]
    171c:	e59f2114 	ldr	r2, [pc, #276]	@ 1838 <malloc+0x160>
    1720:	e51b300c 	ldr	r3, [fp, #-12]
    1724:	e5823000 	str	r3, [r2]
    1728:	e59f3108 	ldr	r3, [pc, #264]	@ 1838 <malloc+0x160>
    172c:	e5933000 	ldr	r3, [r3]
    1730:	e59f2104 	ldr	r2, [pc, #260]	@ 183c <malloc+0x164>
    1734:	e5823000 	str	r3, [r2]
    1738:	e59f30fc 	ldr	r3, [pc, #252]	@ 183c <malloc+0x164>
    ...
    175c:	e1520003 	cmp	r2, r3
    1760:	8a00001e 	bhi	17e0 <malloc+0x108>
    1764:	e51b3008 	ldr	r3, [fp, #-8]
    1768:	e5933004 	ldr	r3, [r3, #4]
    176c:	e51b2010 	ldr	r2, [fp, #-16]
    1770:	e1520003 	cmp	r2, r3
    1774:	1a000004 	bne	178c <malloc+0xb4>
    1778:	e51b3008 	ldr	r3, [fp, #-8]
    177c:	e5932000 	ldr	r2, [r3]
    1780:	e51b300c 	ldr	r3, [fp, #-12]
    1784:	e5832000 	str	r2, [r3]
    1788:	ea00000e 	b	17c8 <malloc+0xf0>
    178c:	e51b3008 	ldr	r3, [fp, #-8]
    1790:	e5932004 	ldr	r2, [r3, #4]
    1794:	e51b3010 	ldr	r3, [fp, #-16]
    1798:	e0422003 	sub	r2, r2, r3
    179c:	e51b3008 	ldr	r3, [fp, #-8]
    17a0:	e5832004 	str	r2, [r3, #4]
    17a4:	e51b3008 	ldr	r3, [fp, #-8]
    17a8:	e5933004 	ldr	r3, [r3, #4]
    17ac:	e1a03183 	lsl	r3, r3, #3
    17b0:	e51b2008 	ldr	r2, [fp, #-8]
    17b4:	e0823003 	add	r3, r2, r3
    17b8:	e50b3008 	str	r3, [fp, #-8]
    17bc:	e51b3008 	ldr	r3, [fp, #-8]
    17c0:	e51b2010 	ldr	r2, [fp, #-16]
    17c4:	e5832004 	str	r2, [r3, #4]
    17c8:	e59f2068 	ldr	r2, [pc, #104]	@ 1838 <malloc+0x160>
    17cc:	e51b300c 	ldr	r3, [fp, #-12]
    17d0:	e5823000 	str	r3, [r2]
    17d4:	e51b3008 	ldr	r3, [fp, #-8]
    17d8:	e2833008 	add	r3, r3, #8
    17dc:	ea000012 	b	182c <malloc+0x154>
    17e0:	e59f3050 	ldr	r3, [pc, #80]	@ 1838 <malloc+0x160>
    17e4:	e5933000 	ldr	r3, [r3]
    17e8:	e51b2008 	ldr	r2, [fp, #-8]
    17ec:	e1520003 	cmp	r2, r3
    17f0:	1a000007 	bne	1814 <malloc+0x13c>
    17f4:	e51b0010 	ldr	r0, [fp, #-16]
    17f8:	ebffff94 	bl	1650 <morecore>
    17fc:	e50b0008 	str	r0, [fp, #-8]
    1800:	e51b3008 	ldr	r3, [fp, #-8]
    1804:	e3530000 	cmp	r3, #0
    1808:	1a000001 	bne	1814 <malloc+0x13c>
    180c:	e3a03000 	mov	r3, #0
    1810:	ea000005 	b	182c <malloc+0x154>
    ...
    1828:	eaffffc8 	b	1750 <malloc+0x78>
    182c:	e1a00003 	mov	r0, r3
    1830:	e24bd004 	sub	sp, fp, #4
    1834:	e8bd8800 	pop	{fp, pc}
    1838:	000019d0 	.word	0x000019d0
    183c:	000019c8 	.word	0x000019c8

00001840 <__udivsi3>:
    1840:	e2512001 	subs	r2, r1, #1
    1844:	012fff1e 	bxeq	lr
    1848:	3a000036 	bcc	1928 <__udivsi3+0xe8>
    184c:	e1500001 	cmp	r0, r1
    1850:	9a000022 	bls	18e0 <__udivsi3+0xa0>
    1854:	e1110002 	tst	r1, r2
    1858:	0a000023 	beq	18ec <__udivsi3+0xac>
    185c:	e311020e 	tst	r1, #-536870912	@ 0xe0000000
    1860:	01a01181 	lsleq	r1, r1, #3
    1864:	03a03008 	moveq	r3, #8
    1868:	13a03001 	movne	r3, #1
    186c:	e3510201 	cmp	r1, #268435456	@ 0x10000000
    1870:	31510000 	cmpcc	r1, r0
    1874:	31a01201 	lslcc	r1, r1, #4
    1878:	31a03203 	lslcc	r3, r3, #4
    187c:	3afffffa 	bcc	186c <__udivsi3+0x2c>
    1880:	e3510102 	cmp	r1, #-2147483648	@ 0x80000000
    1884:	31510000 	cmpcc	r1, r0
    1888:	31a01081 	lslcc	r1, r1, #1
    188c:	31a03083 	lslcc	r3, r3, #1
    1890:	3afffffa 	bcc	1880 <__udivsi3+0x40>
    1894:	e3a02000 	mov	r2, #0
    1898:	e1500001 	cmp	r0, r1
    189c:	20400001 	subcs	r0, r0, r1
    18a0:	21822003 	orrcs	r2, r2, r3
    18a4:	e15000a1 	cmp	r0, r1, lsr #1
    18a8:	204000a1 	subcs	r0, r0, r1, lsr #1
    18ac:	218220a3 	orrcs	r2, r2, r3, lsr #1
    18b0:	e1500121 	cmp	r0, r1, lsr #2
    18b4:	20400121 	subcs	r0, r0, r1, lsr #2
    18b8:	21822123 	orrcs	r2, r2, r3, lsr #2
    18bc:	e15001a1 	cmp	r0, r1, lsr #3
    18c0:	204001a1 	subcs	r0, r0, r1, lsr #3
    18c4:	218221a3 	orrcs	r2, r2, r3, lsr #3
    18c8:	e3500000 	cmp	r0, #0
    18cc:	11b03223 	lsrsne	r3, r3, #4
    18d0:	11a01221 	lsrne	r1, r1, #4
    18d4:	1affffef 	bne	1898 <__udivsi3+0x58>
    18d8:	e1a00002 	mov	r0, r2
    18dc:	e12fff1e 	bx	lr
    18e0:	03a00001 	moveq	r0, #1
    18e4:	13a00000 	movne	r0, #0
    18e8:	e12fff1e 	bx	lr
    18ec:	e3510801 	cmp	r1, #65536	@ 0x10000
    18f0:	21a01821 	lsrcs	r1, r1, #16
    18f4:	23a02010 	movcs	r2, #16
    18f8:	33a02000 	movcc	r2, #0
    18fc:	e3510c01 	cmp	r1, #256	@ 0x100
    1900:	21a01421 	lsrcs	r1, r1, #8
    1904:	22822008 	addcs	r2, r2, #8
    1908:	e3510010 	cmp	r1, #16
    190c:	21a01221 	lsrcs	r1, r1, #4
    1910:	22822004 	addcs	r2, r2, #4
    1914:	e3510004 	cmp	r1, #4
    1918:	82822003 	addhi	r2, r2, #3
    191c:	908220a1 	addls	r2, r2, r1, lsr #1
    1920:	e1a00230 	lsr	r0, r0, r2
    1924:	e12fff1e 	bx	lr
    1928:	e3500000 	cmp	r0, #0
    192c:	13e00000 	mvnne	r0, #0
    1930:	ea000007 	b	1954 <__aeabi_idiv0>

00001934 <__aeabi_uidivmod>:
    1934:	e3510000 	cmp	r1, #0
    1938:	0afffffa 	beq	1928 <__udivsi3+0xe8>
    193c:	e92d4003 	push	{r0, r1, lr}
    1940:	ebffffbe 	bl	1840 <__udivsi3>
    1944:	e8bd4006 	pop	{r1, r2, lr}
    1948:	e0030092 	mul	r3, r2, r0
    194c:	e0411003 	sub	r1, r1, r3
    1950:	e12fff1e 	bx	lr

00001954 <__aeabi_idiv0>:
    1954:	e12fff1e 	bx	lr
