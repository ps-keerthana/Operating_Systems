...
00000144 <main>:
     ...
     16c:	eb0004fe 	bl	156c <printf>
     170:	eb00035b 	bl	ee4 <exit>
     ...
     230:	eb00032b 	bl	ee4 <exit>
     234:	00001c28 	.word	0x00001c28
     238:	00001c48 	.word	0x00001c48
...
00000898 <stat>:
     ...
     8d8:	eb0001e4 	bl	1070 <fstat>
     8dc:	e50b000c 	str	r0, [fp, #-12]
     8e0:	e51b0008 	ldr	r0, [fp, #-8]
     8e4:	eb0001ab 	bl	f98 <close>
...
00000b60 <xchg>:
     ...
     b68:	e24dd014 	sub	sp, sp, #20
     b6c:	e50b0010 	str	r0, [fp, #-16]
     b70:	e50b1014 	str	r1, [fp, #-20]	@ 0xffffffec
     b74:	e51b2010 	ldr	r2, [fp, #-16]
     b78:	e51b1014 	ldr	r1, [fp, #-20]	@ 0xffffffec
     b7c:	e1023091 	swp	r3, r1, [r2]
...
00000c20 <releaseLock>:
     ...
     c34:	e5933004 	ldr	r3, [r3, #4]
     c38:	e3530000 	cmp	r3, #0
     c3c:	0a000006 	beq	c5c <releaseLock+0x3c>
     c40:	e51b3008 	ldr	r3, [fp, #-8]
     c44:	e5933000 	ldr	r3, [r3]
     c48:	e3530001 	cmp	r3, #1
     c4c:	1a000002 	bne	c5c <releaseLock+0x3c>
...
00000d08 <broadcast>:
     ...
     d10:	e24dd008 	sub	sp, sp, #8
     d14:	e50b0008 	str	r0, [fp, #-8]
     d18:	e51b3008 	ldr	r3, [fp, #-8]
     d1c:	e5933004 	ldr	r3, [r3, #4]
     d20:	e3530000 	cmp	r3, #0
     d24:	0a000004 	beq	d3c <broadcast+0x34>
     d28:	e51b3008 	ldr	r3, [fp, #-8]
     d2c:	e5933000 	ldr	r3, [r3]
     d30:	e1a00003 	mov	r0, r3
     d34:	eb000193 	bl	1388 <sigChan>
     d38:	ea000000 	b	d40 <broadcast+0x38>
...
00000d48 <signal>:
     ...
     d64:	0a000004 	beq	d7c <signal+0x34>
     d68:	e51b3008 	ldr	r3, [fp, #-8]
     d6c:	e5933000 	ldr	r3, [r3]
     d70:	e1a00003 	mov	r0, r3
     d74:	eb00018c 	bl	13ac <sigOneChan>
     d78:	ea000000 	b	d80 <signal+0x38>
...
00001100 <dup>:
    1100:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    1104:	e1a04003 	mov	r4, r3
    1108:	e1a03002 	mov	r3, r2
    110c:	e1a02001 	mov	r2, r1
    1110:	e1a01000 	mov	r1, r0
    1114:	e3a0000a 	mov	r0, #10
    1118:	ef000000 	svc	0x00000000
    111c:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    1120:	e12fff1e 	bx	lr

00001124 <getpid>:
    1124:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    1128:	e1a04003 	mov	r4, r3
    112c:	e1a03002 	mov	r3, r2
    1130:	e1a02001 	mov	r2, r1
    1134:	e1a01000 	mov	r1, r0
    1138:	e3a0000b 	mov	r0, #11
    113c:	ef000000 	svc	0x00000000
    1140:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    1144:	e12fff1e 	bx	lr

00001148 <sbrk>:
    1148:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    114c:	e1a04003 	mov	r4, r3
    1150:	e1a03002 	mov	r3, r2
    1154:	e1a02001 	mov	r2, r1
    1158:	e1a01000 	mov	r1, r0
    115c:	e3a0000c 	mov	r0, #12
    1160:	ef000000 	svc	0x00000000
    1164:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    1168:	e12fff1e 	bx	lr

0000116c <sleep>:
    116c:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    1170:	e1a04003 	mov	r4, r3
    1174:	e1a03002 	mov	r3, r2
    1178:	e1a02001 	mov	r2, r1
    117c:	e1a01000 	mov	r1, r0
    1180:	e3a0000d 	mov	r0, #13
    1184:	ef000000 	svc	0x00000000
    1188:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    118c:	e12fff1e 	bx	lr

00001190 <uptime>:
    1190:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    1194:	e1a04003 	mov	r4, r3
    1198:	e1a03002 	mov	r3, r2
    119c:	e1a02001 	mov	r2, r1
    11a0:	e1a01000 	mov	r1, r0
    11a4:	e3a0000e 	mov	r0, #14
    11a8:	ef000000 	svc	0x00000000
    11ac:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    11b0:	e12fff1e 	bx	lr

000011b4 <proclist>:
    11b4:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    11b8:	e1a04003 	mov	r4, r3
    11bc:	e1a03002 	mov	r3, r2
    11c0:	e1a02001 	mov	r2, r1
    11c4:	e1a01000 	mov	r1, r0
    11c8:	e3a00016 	mov	r0, #22
    11cc:	ef000000 	svc	0x00000000
    11d0:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    11d4:	e12fff1e 	bx	lr

000011d8 <settickets>:
    11d8:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    11dc:	e1a04003 	mov	r4, r3
    11e0:	e1a03002 	mov	r3, r2
    11e4:	e1a02001 	mov	r2, r1
    11e8:	e1a01000 	mov	r1, r0
    11ec:	e3a00017 	mov	r0, #23
    11f0:	ef000000 	svc	0x00000000
    11f4:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    11f8:	e12fff1e 	bx	lr

000011fc <srand>:
    11fc:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    1200:	e1a04003 	mov	r4, r3
    1204:	e1a03002 	mov	r3, r2
    1208:	e1a02001 	mov	r2, r1
    120c:	e1a01000 	mov	r1, r0
    1210:	e3a00018 	mov	r0, #24
    1214:	ef000000 	svc	0x00000000
    1218:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    121c:	e12fff1e 	bx	lr

00001220 <getpinfo>:
    1220:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    1224:	e1a04003 	mov	r4, r3
    1228:	e1a03002 	mov	r3, r2
    122c:	e1a02001 	mov	r2, r1
    1230:	e1a01000 	mov	r1, r0
    1234:	e3a00019 	mov	r0, #25
    1238:	ef000000 	svc	0x00000000
    123c:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    1240:	e12fff1e 	bx	lr

00001244 <print_pt>:
    1244:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    1248:	e1a04003 	mov	r4, r3
    124c:	e1a03002 	mov	r3, r2
    1250:	e1a02001 	mov	r2, r1
    1254:	e1a01000 	mov	r1, r0
    1258:	e3a0001f 	mov	r0, #31
    125c:	ef000000 	svc	0x00000000
    1260:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    1264:	e12fff1e 	bx	lr

00001268 <thread_create>:
    1268:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    126c:	e1a04003 	mov	r4, r3
    1270:	e1a03002 	mov	r3, r2
    1274:	e1a02001 	mov	r2, r1
    1278:	e1a01000 	mov	r1, r0
    127c:	e3a00020 	mov	r0, #32
    1280:	ef000000 	svc	0x00000000
    1284:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    1288:	e12fff1e 	bx	lr

0000128c <thread_exit>:
    128c:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    1290:	e1a04003 	mov	r4, r3
    1294:	e1a03002 	mov	r3, r2
    1298:	e1a02001 	mov	r2, r1
    129c:	e1a01000 	mov	r1, r0
    12a0:	e3a00021 	mov	r0, #33	@ 0x21
    12a4:	ef000000 	svc	0x00000000
    12a8:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    12ac:	e12fff1e 	bx	lr

000012b0 <thread_join>:
    12b0:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    12b4:	e1a04003 	mov	r4, r3
    12b8:	e1a03002 	mov	r3, r2
    12bc:	e1a02001 	mov	r2, r1
    12c0:	e1a01000 	mov	r1, r0
    12c4:	e3a00022 	mov	r0, #34	@ 0x22
    12c8:	ef000000 	svc	0x00000000
    12cc:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    12d0:	e12fff1e 	bx	lr

000012d4 <waitpid>:
    12d4:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    12d8:	e1a04003 	mov	r4, r3
    12dc:	e1a03002 	mov	r3, r2
    12e0:	e1a02001 	mov	r2, r1
    12e4:	e1a01000 	mov	r1, r0
    12e8:	e3a00023 	mov	r0, #35	@ 0x23
    12ec:	ef000000 	svc	0x00000000
    12f0:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    12f4:	e12fff1e 	bx	lr

000012f8 <barrier_init>:
    12f8:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    12fc:	e1a04003 	mov	r4, r3
    1300:	e1a03002 	mov	r3, r2
    1304:	e1a02001 	mov	r2, r1
    1308:	e1a01000 	mov	r1, r0
    130c:	e3a00024 	mov	r0, #36	@ 0x24
    1310:	ef000000 	svc	0x00000000
    1314:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    1318:	e12fff1e 	bx	lr

0000131c <barrier_check>:
    131c:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    1320:	e1a04003 	mov	r4, r3
    1324:	e1a03002 	mov	r3, r2
    1328:	e1a02001 	mov	r2, r1
    132c:	e1a01000 	mov	r1, r0
    1330:	e3a00025 	mov	r0, #37	@ 0x25
    1334:	ef000000 	svc	0x00000000
    1338:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    133c:	e12fff1e 	bx	lr

00001340 <sleepChan>:
    1340:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    1344:	e1a04003 	mov	r4, r3
    1348:	e1a03002 	mov	r3, r2
    134c:	e1a02001 	mov	r2, r1
    1350:	e1a01000 	mov	r1, r0
    1354:	e3a00026 	mov	r0, #38	@ 0x26
    1358:	ef000000 	svc	0x00000000
    135c:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    1360:	e12fff1e 	bx	lr

00001364 <getChannel>:
    1364:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    1368:	e1a04003 	mov	r4, r3
    136c:	e1a03002 	mov	r3, r2
    1370:	e1a02001 	mov	r2, r1
    1374:	e1a01000 	mov	r1, r0
    1378:	e3a00027 	mov	r0, #39	@ 0x27
    137c:	ef000000 	svc	0x00000000
    1380:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    1384:	e12fff1e 	bx	lr

00001388 <sigChan>:
    1388:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    138c:	e1a04003 	mov	r4, r3
    1390:	e1a03002 	mov	r3, r2
    1394:	e1a02001 	mov	r2, r1
    1398:	e1a01000 	mov	r1, r0
    139c:	e3a00028 	mov	r0, #40	@ 0x28
    13a0:	ef000000 	svc	0x00000000
    13a4:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    13a8:	e12fff1e 	bx	lr

000013ac <sigOneChan>:
    13ac:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    13b0:	e1a04003 	mov	r4, r3
    13b4:	e1a03002 	mov	r3, r2
    13b8:	e1a02001 	mov	r2, r1
    13bc:	e1a01000 	mov	r1, r0
    13c0:	e3a00029 	mov	r0, #41	@ 0x29
    13c4:	ef000000 	svc	0x00000000
    13c8:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    13cc:	e12fff1e 	bx	lr

000013d0 <symlink>:
    13d0:	e52d4004 	push	{r4}		@ (str r4, [sp, #-4]!)
    13d4:	e1a04003 	mov	r4, r3
    13d8:	e1a03002 	mov	r3, r2
    13dc:	e1a02001 	mov	r2, r1
    13e0:	e1a01000 	mov	r1, r0
    13e4:	e3a0002a 	mov	r0, #42	@ 0x2a
    13e8:	ef000000 	svc	0x00000000
    13ec:	e49d4004 	pop	{r4}		@ (ldr r4, [sp], #4)
    13f0:	e12fff1e 	bx	lr

000013f4 <syscall>:
    13f4:	ef000000 	svc	0x00000000
    13f8:	e12fff1e 	bx	lr

000013fc <putc>:
    13fc:	e92d4800 	push	{fp, lr}
    1400:	e28db004 	add	fp, sp, #4
    1404:	e24dd008 	sub	sp, sp, #8
    1408:	e50b0008 	str	r0, [fp, #-8]
    140c:	e1a03001 	mov	r3, r1
    1410:	e54b3009 	strb	r3, [fp, #-9]
    1414:	e24b3009 	sub	r3, fp, #9
    1418:	e3a02001 	mov	r2, #1
    141c:	e1a01003 	mov	r1, r3
    1420:	e51b0008 	ldr	r0, [fp, #-8]
    1424:	ebfffed2 	bl	f74 <write>
...
00001434 <printint>:
    ...
    143c:	e24dd030 	sub	sp, sp, #48	@ 0x30
    1440:	e50b0028 	str	r0, [fp, #-40]	@ 0xffffffd8
    1444:	e50b102c 	str	r1, [fp, #-44]	@ 0xffffffd4
    1448:	e50b2030 	str	r2, [fp, #-48]	@ 0xffffffd0
    144c:	e50b3034 	str	r3, [fp, #-52]	@ 0xffffffcc
    1450:	e3a03000 	mov	r3, #0
    1454:	e50b300c 	str	r3, [fp, #-12]
    1458:	e51b3034 	ldr	r3, [fp, #-52]	@ 0xffffffcc
    145c:	e3530000 	cmp	r3, #0
    1460:	0a000008 	beq	1488 <printint+0x54>
    1464:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    1468:	e3530000 	cmp	r3, #0
    146c:	aa000005 	bge	1488 <printint+0x54>
    1470:	e3a03001 	mov	r3, #1
    1474:	e50b300c 	str	r3, [fp, #-12]
    1478:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    147c:	e2633000 	rsb	r3, r3, #0
    1480:	e50b3010 	str	r3, [fp, #-16]
    1484:	ea000001 	b	1490 <printint+0x5c>
    1488:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    148c:	e50b3010 	str	r3, [fp, #-16]
    1490:	e3a03000 	mov	r3, #0
    1494:	e50b3008 	str	r3, [fp, #-8]
    1498:	e51b2030 	ldr	r2, [fp, #-48]	@ 0xffffffd0
    149c:	e51b3010 	ldr	r3, [fp, #-16]
    14a0:	e1a01002 	mov	r1, r2
    14a4:	e1a00003 	mov	r0, r3
    14a8:	eb0001d5 	bl	1c04 <__aeabi_uidivmod>
    14ac:	e1a03001 	mov	r3, r1
    14b0:	e1a01003 	mov	r1, r3
    14b4:	e51b3008 	ldr	r3, [fp, #-8]
    14b8:	e2832001 	add	r2, r3, #1
    14bc:	e50b2008 	str	r2, [fp, #-8]
    14c0:	e59f20a0 	ldr	r2, [pc, #160]	@ 1568 <printint+0x134>
    14c4:	e7d22001 	ldrb	r2, [r2, r1]
    14c8:	e2433004 	sub	r3, r3, #4
    14cc:	e083300b 	add	r3, r3, fp
    14d0:	e543201c 	strb	r2, [r3, #-28]	@ 0xffffffe4
    14d4:	e51b3030 	ldr	r3, [fp, #-48]	@ 0xffffffd0
    14d8:	e1a01003 	mov	r1, r3
    14dc:	e51b0010 	ldr	r0, [fp, #-16]
    14e0:	eb00018a 	bl	1b10 <__udivsi3>
    14e4:	e1a03000 	mov	r3, r0
    14e8:	e50b3010 	str	r3, [fp, #-16]
    14ec:	e51b3010 	ldr	r3, [fp, #-16]
    14f0:	e3530000 	cmp	r3, #0
    14f4:	1affffe7 	bne	1498 <printint+0x64>
    14f8:	e51b300c 	ldr	r3, [fp, #-12]
    14fc:	e3530000 	cmp	r3, #0
    1500:	0a00000e 	beq	1540 <printint+0x10c>
    1504:	e51b3008 	ldr	r3, [fp, #-8]
    1508:	e2832001 	add	r2, r3, #1
    150c:	e50b2008 	str	r2, [fp, #-8]
    1510:	e2433004 	sub	r3, r3, #4
    1514:	e083300b 	add	r3, r3, fp
    1518:	e3a0202d 	mov	r2, #45	@ 0x2d
    151c:	e543201c 	strb	r2, [r3, #-28]	@ 0xffffffe4
    1520:	ea000006 	b	1540 <printint+0x10c>
    1524:	e24b2020 	sub	r2, fp, #32
    1528:	e51b3008 	ldr	r3, [fp, #-8]
    152c:	e0823003 	add	r3, r2, r3
    1530:	e5d33000 	ldrb	r3, [r3]
    1534:	e1a01003 	mov	r1, r3
    1538:	e51b0028 	ldr	r0, [fp, #-40]	@ 0xffffffd8
    153c:	ebffffae 	bl	13fc <putc>
    1540:	e51b3008 	ldr	r3, [fp, #-8]
    1544:	e2433001 	sub	r3, r3, #1
    1548:	e50b3008 	str	r3, [fp, #-8]
    154c:	e51b3008 	ldr	r3, [fp, #-8]
    1550:	e3530000 	cmp	r3, #0
    1554:	aafffff2 	bge	1524 <printint+0xf0>
    1558:	e1a00000 	nop			@ (mov r0, r0)
    155c:	e1a00000 	nop			@ (mov r0, r0)
    1560:	e24bd004 	sub	sp, fp, #4
    1564:	e8bd8800 	pop	{fp, pc}
    1568:	00001c68 	.word	0x00001c68

0000156c <printf>:
    156c:	e92d000e 	push	{r1, r2, r3}
    1570:	e92d4800 	push	{fp, lr}
    1574:	e28db004 	add	fp, sp, #4
    1578:	e24dd024 	sub	sp, sp, #36	@ 0x24
    157c:	e50b0024 	str	r0, [fp, #-36]	@ 0xffffffdc
    1580:	e3a03000 	mov	r3, #0
    1584:	e50b3014 	str	r3, [fp, #-20]	@ 0xffffffec
    1588:	e28b3008 	add	r3, fp, #8
    158c:	e50b3018 	str	r3, [fp, #-24]	@ 0xffffffe8
    1590:	e3a03000 	mov	r3, #0
    1594:	e50b3010 	str	r3, [fp, #-16]
    1598:	ea000074 	b	1770 <printf+0x204>
    159c:	e59b2004 	ldr	r2, [fp, #4]
    15a0:	e51b3010 	ldr	r3, [fp, #-16]
    15a4:	e0823003 	add	r3, r2, r3
    15a8:	e5d33000 	ldrb	r3, [r3]
    15ac:	e50b301c 	str	r3, [fp, #-28]	@ 0xffffffe4
    15b0:	e51b3014 	ldr	r3, [fp, #-20]	@ 0xffffffec
    15b4:	e3530000 	cmp	r3, #0
    15b8:	1a00000b 	bne	15ec <printf+0x80>
    15bc:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    15c0:	e3530025 	cmp	r3, #37	@ 0x25
    15c4:	1a000002 	bne	15d4 <printf+0x68>
    15c8:	e3a03025 	mov	r3, #37	@ 0x25
    15cc:	e50b3014 	str	r3, [fp, #-20]	@ 0xffffffec
    15d0:	ea000063 	b	1764 <printf+0x1f8>
    ...
    15e4:	ebffff84 	bl	13fc <putc>
    15e8:	ea00005d 	b	1764 <printf+0x1f8>
    15ec:	e51b3014 	ldr	r3, [fp, #-20]	@ 0xffffffec
    15f0:	e3530025 	cmp	r3, #37	@ 0x25
    15f4:	1a00005a 	bne	1764 <printf+0x1f8>
    15f8:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    15fc:	e3530064 	cmp	r3, #100	@ 0x64
    1600:	1a00000a 	bne	1630 <printf+0xc4>
    1604:	e51b3018 	ldr	r3, [fp, #-24]	@ 0xffffffe8
    1608:	e5933000 	ldr	r3, [r3]
    160c:	e1a01003 	mov	r1, r3
    1610:	e3a03001 	mov	r3, #1
    1614:	e3a0200a 	mov	r2, #10
    1618:	e51b0024 	ldr	r0, [fp, #-36]	@ 0xffffffdc
    161c:	ebffff84 	bl	1434 <printint>
    1620:	e51b3018 	ldr	r3, [fp, #-24]	@ 0xffffffe8
    1624:	e2833004 	add	r3, r3, #4
    1628:	e50b3018 	str	r3, [fp, #-24]	@ 0xffffffe8
    162c:	ea00004a 	b	175c <printf+0x1f0>
    1630:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    1634:	e3530078 	cmp	r3, #120	@ 0x78
    1638:	0a000002 	beq	1648 <printf+0xdc>
    163c:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    1640:	e3530070 	cmp	r3, #112	@ 0x70
    1644:	1a00000a 	bne	1674 <printf+0x108>
    1648:	e51b3018 	ldr	r3, [fp, #-24]	@ 0xffffffe8
    164c:	e5933000 	ldr	r3, [r3]
    1650:	e1a01003 	mov	r1, r3
    1654:	e3a03000 	mov	r3, #0
    1658:	e3a02010 	mov	r2, #16
    165c:	e51b0024 	ldr	r0, [fp, #-36]	@ 0xffffffdc
    1660:	ebffff73 	bl	1434 <printint>
    1664:	e51b3018 	ldr	r3, [fp, #-24]	@ 0xffffffe8
    1668:	e2833004 	add	r3, r3, #4
    166c:	e50b3018 	str	r3, [fp, #-24]	@ 0xffffffe8
    1670:	ea000039 	b	175c <printf+0x1f0>
    1674:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    1678:	e3530073 	cmp	r3, #115	@ 0x73
    167c:	1a000018 	bne	16e4 <printf+0x178>
    ...
    1690:	e2833004 	add	r3, r3, #4
    1694:	e50b3018 	str	r3, [fp, #-24]	@ 0xffffffe8
    1698:	e51b300c 	ldr	r3, [fp, #-12]
    169c:	e3530000 	cmp	r3, #0
    16a0:	1a00000a 	bne	16d0 <printf+0x164>
    16a4:	e59f30f4 	ldr	r3, [pc, #244]	@ 17a0 <printf+0x234>
    16a8:	e50b300c 	str	r3, [fp, #-12]
    16ac:	ea000007 	b	16d0 <printf+0x164>
    16b0:	e51b300c 	ldr	r3, [fp, #-12]
    16b4:	e5d33000 	ldrb	r3, [r3]
    16b8:	e1a01003 	mov	r1, r3
    16bc:	e51b0024 	ldr	r0, [fp, #-36]	@ 0xffffffdc
    16c0:	ebffff4d 	bl	13fc <putc>
    16c4:	e51b300c 	ldr	r3, [fp, #-12]
    16c8:	e2833001 	add	r3, r3, #1
    16cc:	e50b300c 	str	r3, [fp, #-12]
    16d0:	e51b300c 	ldr	r3, [fp, #-12]
    16d4:	e5d33000 	ldrb	r3, [r3]
    16d8:	e3530000 	cmp	r3, #0
    16dc:	1afffff3 	bne	16b0 <printf+0x144>
    16e0:	ea00001d 	b	175c <printf+0x1f0>
    16e4:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    16e8:	e3530063 	cmp	r3, #99	@ 0x63
    16ec:	1a000009 	bne	1718 <printf+0x1ac>
    16f0:	e51b3018 	ldr	r3, [fp, #-24]	@ 0xffffffe8
    16f4:	e5933000 	ldr	r3, [r3]
    16f8:	e6ef3073 	uxtb	r3, r3
    16fc:	e1a01003 	mov	r1, r3
    1700:	e51b0024 	ldr	r0, [fp, #-36]	@ 0xffffffdc
    1704:	ebffff3c 	bl	13fc <putc>
    1708:	e51b3018 	ldr	r3, [fp, #-24]	@ 0xffffffe8
    170c:	e2833004 	add	r3, r3, #4
    1710:	e50b3018 	str	r3, [fp, #-24]	@ 0xffffffe8
    1714:	ea000010 	b	175c <printf+0x1f0>
    1718:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    171c:	e3530025 	cmp	r3, #37	@ 0x25
    1720:	1a000005 	bne	173c <printf+0x1d0>
    1724:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    1728:	e6ef3073 	uxtb	r3, r3
    172c:	e1a01003 	mov	r1, r3
    1730:	e51b0024 	ldr	r0, [fp, #-36]	@ 0xffffffdc
    1734:	ebffff30 	bl	13fc <putc>
    1738:	ea000007 	b	175c <printf+0x1f0>
    173c:	e3a01025 	mov	r1, #37	@ 0x25
    1740:	e51b0024 	ldr	r0, [fp, #-36]	@ 0xffffffdc
    1744:	ebffff2c 	bl	13fc <putc>
    1748:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    174c:	e6ef3073 	uxtb	r3, r3
    1750:	e1a01003 	mov	r1, r3
    1754:	e51b0024 	ldr	r0, [fp, #-36]	@ 0xffffffdc
    1758:	ebffff27 	bl	13fc <putc>
    175c:	e3a03000 	mov	r3, #0
    1760:	e50b3014 	str	r3, [fp, #-20]	@ 0xffffffec
    1764:	e51b3010 	ldr	r3, [fp, #-16]
    1768:	e2833001 	add	r3, r3, #1
    176c:	e50b3010 	str	r3, [fp, #-16]
    1770:	e59b2004 	ldr	r2, [fp, #4]
    1774:	e51b3010 	ldr	r3, [fp, #-16]
    1778:	e0823003 	add	r3, r2, r3
    177c:	e5d33000 	ldrb	r3, [r3]
    1780:	e3530000 	cmp	r3, #0
    1784:	1affff84 	bne	159c <printf+0x30>
    1788:	e1a00000 	nop			@ (mov r0, r0)
    178c:	e1a00000 	nop			@ (mov r0, r0)
    1790:	e24bd004 	sub	sp, fp, #4
    1794:	e8bd4800 	pop	{fp, lr}
    1798:	e28dd00c 	add	sp, sp, #12
    179c:	e12fff1e 	bx	lr
    17a0:	00001c60 	.word	0x00001c60

000017a4 <free>:
    17a4:	e52db004 	push	{fp}		@ (str fp, [sp, #-4]!)
    17a8:	e28db000 	add	fp, sp, #0
    17ac:	e24dd014 	sub	sp, sp, #20
    17b0:	e50b0010 	str	r0, [fp, #-16]
    17b4:	e51b3010 	ldr	r3, [fp, #-16]
    17b8:	e2433008 	sub	r3, r3, #8
    17bc:	e50b300c 	str	r3, [fp, #-12]
    17c0:	e59f3154 	ldr	r3, [pc, #340]	@ 191c <free+0x178>
    17c4:	e5933000 	ldr	r3, [r3]
    17c8:	e50b3008 	str	r3, [fp, #-8]
    17cc:	ea000010 	b	1814 <free+0x70>
    17d0:	e51b3008 	ldr	r3, [fp, #-8]
    17d4:	e5933000 	ldr	r3, [r3]
    17d8:	e51b2008 	ldr	r2, [fp, #-8]
    17dc:	e1520003 	cmp	r2, r3
    17e0:	3a000008 	bcc	1808 <free+0x64>
    17e4:	e51b200c 	ldr	r2, [fp, #-12]
    17e8:	e51b3008 	ldr	r3, [fp, #-8]
    17ec:	e1520003 	cmp	r2, r3
    17f0:	8a000010 	bhi	1838 <free+0x94>
    17f4:	e51b3008 	ldr	r3, [fp, #-8]
    17f8:	e5933000 	ldr	r3, [r3]
    17fc:	e51b200c 	ldr	r2, [fp, #-12]
    1800:	e1520003 	cmp	r2, r3
    1804:	3a00000b 	bcc	1838 <free+0x94>
    1808:	e51b3008 	ldr	r3, [fp, #-8]
    180c:	e5933000 	ldr	r3, [r3]
    1810:	e50b3008 	str	r3, [fp, #-8]
    1814:	e51b200c 	ldr	r2, [fp, #-12]
    1818:	e51b3008 	ldr	r3, [fp, #-8]
    181c:	e1520003 	cmp	r2, r3
    1820:	9affffea 	bls	17d0 <free+0x2c>
    1824:	e51b3008 	ldr	r3, [fp, #-8]
    1828:	e5933000 	ldr	r3, [r3]
    182c:	e51b200c 	ldr	r2, [fp, #-12]
    1830:	e1520003 	cmp	r2, r3
    1834:	2affffe5 	bcs	17d0 <free+0x2c>
    1838:	e51b300c 	ldr	r3, [fp, #-12]
    183c:	e5933004 	ldr	r3, [r3, #4]
    1840:	e1a03183 	lsl	r3, r3, #3
    1844:	e51b200c 	ldr	r2, [fp, #-12]
    1848:	e0822003 	add	r2, r2, r3
    184c:	e51b3008 	ldr	r3, [fp, #-8]
    1850:	e5933000 	ldr	r3, [r3]
    1854:	e1520003 	cmp	r2, r3
    1858:	1a00000d 	bne	1894 <free+0xf0>
    185c:	e51b300c 	ldr	r3, [fp, #-12]
    1860:	e5932004 	ldr	r2, [r3, #4]
    1864:	e51b3008 	ldr	r3, [fp, #-8]
    1868:	e5933000 	ldr	r3, [r3]
    186c:	e5933004 	ldr	r3, [r3, #4]
    1870:	e0822003 	add	r2, r2, r3
    1874:	e51b300c 	ldr	r3, [fp, #-12]
    1878:	e5832004 	str	r2, [r3, #4]
    187c:	e51b3008 	ldr	r3, [fp, #-8]
    1880:	e5933000 	ldr	r3, [r3]
    1884:	e5932000 	ldr	r2, [r3]
    1888:	e51b300c 	ldr	r3, [fp, #-12]
    188c:	e5832000 	str	r2, [r3]
    1890:	ea000003 	b	18a4 <free+0x100>
    1894:	e51b3008 	ldr	r3, [fp, #-8]
    1898:	e5932000 	ldr	r2, [r3]
    189c:	e51b300c 	ldr	r3, [fp, #-12]
    18a0:	e5832000 	str	r2, [r3]
    18a4:	e51b3008 	ldr	r3, [fp, #-8]
    18a8:	e5933004 	ldr	r3, [r3, #4]
    18ac:	e1a03183 	lsl	r3, r3, #3
    18b0:	e51b2008 	ldr	r2, [fp, #-8]
    18b4:	e0823003 	add	r3, r2, r3
    18b8:	e51b200c 	ldr	r2, [fp, #-12]
    18bc:	e1520003 	cmp	r2, r3
    18c0:	1a00000b 	bne	18f4 <free+0x150>
    18c4:	e51b3008 	ldr	r3, [fp, #-8]
    18c8:	e5932004 	ldr	r2, [r3, #4]
    18cc:	e51b300c 	ldr	r3, [fp, #-12]
    18d0:	e5933004 	ldr	r3, [r3, #4]
    18d4:	e0822003 	add	r2, r2, r3
    18d8:	e51b3008 	ldr	r3, [fp, #-8]
    18dc:	e5832004 	str	r2, [r3, #4]
    18e0:	e51b300c 	ldr	r3, [fp, #-12]
    18e4:	e5932000 	ldr	r2, [r3]
    18e8:	e51b3008 	ldr	r3, [fp, #-8]
    18ec:	e5832000 	str	r2, [r3]
    18f0:	ea000002 	b	1900 <free+0x15c>
    18f4:	e51b3008 	ldr	r3, [fp, #-8]
    18f8:	e51b200c 	ldr	r2, [fp, #-12]
    18fc:	e5832000 	str	r2, [r3]
    1900:	e59f2014 	ldr	r2, [pc, #20]	@ 191c <free+0x178>
    1904:	e51b3008 	ldr	r3, [fp, #-8]
    1908:	e5823000 	str	r3, [r2]
    190c:	e1a00000 	nop			@ (mov r0, r0)
    1910:	e28bd000 	add	sp, fp, #0
    1914:	e49db004 	pop	{fp}		@ (ldr fp, [sp], #4)
    1918:	e12fff1e 	bx	lr
    191c:	00002084 	.word	0x00002084

00001920 <morecore>:
    1920:	e92d4800 	push	{fp, lr}
    1924:	e28db004 	add	fp, sp, #4
    1928:	e24dd010 	sub	sp, sp, #16
    192c:	e50b0010 	str	r0, [fp, #-16]
    1930:	e51b3010 	ldr	r3, [fp, #-16]
    1934:	e3530a01 	cmp	r3, #4096	@ 0x1000
    1938:	2a000001 	bcs	1944 <morecore+0x24>
    193c:	e3a03a01 	mov	r3, #4096	@ 0x1000
    1940:	e50b3010 	str	r3, [fp, #-16]
    1944:	e51b3010 	ldr	r3, [fp, #-16]
    1948:	e1a03183 	lsl	r3, r3, #3
    194c:	e1a00003 	mov	r0, r3
    1950:	ebfffdfc 	bl	1148 <sbrk>
    1954:	e50b0008 	str	r0, [fp, #-8]
    1958:	e51b3008 	ldr	r3, [fp, #-8]
    195c:	e3730001 	cmn	r3, #1
    1960:	1a000001 	bne	196c <morecore+0x4c>
    1964:	e3a03000 	mov	r3, #0
    1968:	ea00000a 	b	1998 <morecore+0x78>
    196c:	e51b3008 	ldr	r3, [fp, #-8]
    1970:	e50b300c 	str	r3, [fp, #-12]
    1974:	e51b300c 	ldr	r3, [fp, #-12]
    1978:	e51b2010 	ldr	r2, [fp, #-16]
    197c:	e5832004 	str	r2, [r3, #4]
    1980:	e51b300c 	ldr	r3, [fp, #-12]
    1984:	e2833008 	add	r3, r3, #8
    1988:	e1a00003 	mov	r0, r3
    198c:	ebffff84 	bl	17a4 <free>
    1990:	e59f300c 	ldr	r3, [pc, #12]	@ 19a4 <morecore+0x84>
    1994:	e5933000 	ldr	r3, [r3]
    1998:	e1a00003 	mov	r0, r3
    199c:	e24bd004 	sub	sp, fp, #4
    19a0:	e8bd8800 	pop	{fp, pc}
    19a4:	00002084 	.word	0x00002084

000019a8 <malloc>:
    19a8:	e92d4800 	push	{fp, lr}
    19ac:	e28db004 	add	fp, sp, #4
    19b0:	e24dd018 	sub	sp, sp, #24
    19b4:	e50b0018 	str	r0, [fp, #-24]	@ 0xffffffe8
    19b8:	e51b3018 	ldr	r3, [fp, #-24]	@ 0xffffffe8
    19bc:	e2833007 	add	r3, r3, #7
    19c0:	e1a031a3 	lsr	r3, r3, #3
    19c4:	e2833001 	add	r3, r3, #1
    19c8:	e50b3010 	str	r3, [fp, #-16]
    19cc:	e59f3134 	ldr	r3, [pc, #308]	@ 1b08 <malloc+0x160>
    19d0:	e5933000 	ldr	r3, [r3]
    19d4:	e50b300c 	str	r3, [fp, #-12]
    19d8:	e51b300c 	ldr	r3, [fp, #-12]
    19dc:	e3530000 	cmp	r3, #0
    19e0:	1a00000b 	bne	1a14 <malloc+0x6c>
    19e4:	e59f3120 	ldr	r3, [pc, #288]	@ 1b0c <malloc+0x164>
    19e8:	e50b300c 	str	r3, [fp, #-12]
    19ec:	e59f2114 	ldr	r2, [pc, #276]	@ 1b08 <malloc+0x160>
    19f0:	e51b300c 	ldr	r3, [fp, #-12]
    19f4:	e5823000 	str	r3, [r2]
    19f8:	e59f3108 	ldr	r3, [pc, #264]	@ 1b08 <malloc+0x160>
    19fc:	e5933000 	ldr	r3, [r3]
    1a00:	e59f2104 	ldr	r2, [pc, #260]	@ 1b0c <malloc+0x164>
    1a04:	e5823000 	str	r3, [r2]
    1a08:	e59f30fc 	ldr	r3, [pc, #252]	@ 1b0c <malloc+0x164>
    1a0c:	e3a02000 	mov	r2, #0
    1a10:	e5832004 	str	r2, [r3, #4]
    1a14:	e51b300c 	ldr	r3, [fp, #-12]
    1a18:	e5933000 	ldr	r3, [r3]
    1a1c:	e50b3008 	str	r3, [fp, #-8]
    1a20:	e51b3008 	ldr	r3, [fp, #-8]
    1a24:	e5933004 	ldr	r3, [r3, #4]
    1a28:	e51b2010 	ldr	r2, [fp, #-16]
    1a2c:	e1520003 	cmp	r2, r3
    1a30:	8a00001e 	bhi	1ab0 <malloc+0x108>
    1a34:	e51b3008 	ldr	r3, [fp, #-8]
    1a38:	e5933004 	ldr	r3, [r3, #4]
    1a3c:	e51b2010 	ldr	r2, [fp, #-16]
    1a40:	e1520003 	cmp	r2, r3
    1a44:	1a000004 	bne	1a5c <malloc+0xb4>
    1a48:	e51b3008 	ldr	r3, [fp, #-8]
    1a4c:	e5932000 	ldr	r2, [r3]
    1a50:	e51b300c 	ldr	r3, [fp, #-12]
    1a54:	e5832000 	str	r2, [r3]
    1a58:	ea00000e 	b	1a98 <malloc+0xf0>
    1a5c:	e51b3008 	ldr	r3, [fp, #-8]
    1a60:	e5932004 	ldr	r2, [r3, #4]
    1a64:	e51b3010 	ldr	r3, [fp, #-16]
    1a68:	e0422003 	sub	r2, r2, r3
    1a6c:	e51b3008 	ldr	r3, [fp, #-8]
    1a70:	e5832004 	str	r2, [r3, #4]
    1a74:	e51b3008 	ldr	r3, [fp, #-8]
    1a78:	e5933004 	ldr	r3, [r3, #4]
    1a7c:	e1a03183 	lsl	r3, r3, #3
    1a80:	e51b2008 	ldr	r2, [fp, #-8]
    1a84:	e0823003 	add	r3, r2, r3
    1a88:	e50b3008 	str	r3, [fp, #-8]
    1a8c:	e51b3008 	ldr	r3, [fp, #-8]
    1a90:	e51b2010 	ldr	r2, [fp, #-16]
    1a94:	e5832004 	str	r2, [r3, #4]
    1a98:	e59f2068 	ldr	r2, [pc, #104]	@ 1b08 <malloc+0x160>
    1a9c:	e51b300c 	ldr	r3, [fp, #-12]
    1aa0:	e5823000 	str	r3, [r2]
    1aa4:	e51b3008 	ldr	r3, [fp, #-8]
    1aa8:	e2833008 	add	r3, r3, #8
    1aac:	ea000012 	b	1afc <malloc+0x154>
    1ab0:	e59f3050 	ldr	r3, [pc, #80]	@ 1b08 <malloc+0x160>
    1ab4:	e5933000 	ldr	r3, [r3]
    1ab8:	e51b2008 	ldr	r2, [fp, #-8]
    1abc:	e1520003 	cmp	r2, r3
    1ac0:	1a000007 	bne	1ae4 <malloc+0x13c>
    1ac4:	e51b0010 	ldr	r0, [fp, #-16]
    1ac8:	ebffff94 	bl	1920 <morecore>
    1acc:	e50b0008 	str	r0, [fp, #-8]
    1ad0:	e51b3008 	ldr	r3, [fp, #-8]
    1ad4:	e3530000 	cmp	r3, #0
    1ad8:	1a000001 	bne	1ae4 <malloc+0x13c>
    1adc:	e3a03000 	mov	r3, #0
    1ae0:	ea000005 	b	1afc <malloc+0x154>
    1ae4:	e51b3008 	ldr	r3, [fp, #-8]
    1ae8:	e50b300c 	str	r3, [fp, #-12]
    1aec:	e51b3008 	ldr	r3, [fp, #-8]
    1af0:	e5933000 	ldr	r3, [r3]
    1af4:	e50b3008 	str	r3, [fp, #-8]
    1af8:	eaffffc8 	b	1a20 <malloc+0x78>
    1afc:	e1a00003 	mov	r0, r3
    1b00:	e24bd004 	sub	sp, fp, #4
    1b04:	e8bd8800 	pop	{fp, pc}
    1b08:	00002084 	.word	0x00002084
    1b0c:	0000207c 	.word	0x0000207c

00001b10 <__udivsi3>:
    1b10:	e2512001 	subs	r2, r1, #1
    1b14:	012fff1e 	bxeq	lr
    1b18:	3a000036 	bcc	1bf8 <__udivsi3+0xe8>
    1b1c:	e1500001 	cmp	r0, r1
    1b20:	9a000022 	bls	1bb0 <__udivsi3+0xa0>
    1b24:	e1110002 	tst	r1, r2
    1b28:	0a000023 	beq	1bbc <__udivsi3+0xac>
    1b2c:	e311020e 	tst	r1, #-536870912	@ 0xe0000000
    1b30:	01a01181 	lsleq	r1, r1, #3
    1b34:	03a03008 	moveq	r3, #8
    1b38:	13a03001 	movne	r3, #1
    1b3c:	e3510201 	cmp	r1, #268435456	@ 0x10000000
    1b40:	31510000 	cmpcc	r1, r0
    1b44:	31a01201 	lslcc	r1, r1, #4
    1b48:	31a03203 	lslcc	r3, r3, #4
    1b4c:	3afffffa 	bcc	1b3c <__udivsi3+0x2c>
    1b50:	e3510102 	cmp	r1, #-2147483648	@ 0x80000000
    1b54:	31510000 	cmpcc	r1, r0
    1b58:	31a01081 	lslcc	r1, r1, #1
    1b5c:	31a03083 	lslcc	r3, r3, #1
    1b60:	3afffffa 	bcc	1b50 <__udivsi3+0x40>
    1b64:	e3a02000 	mov	r2, #0
    1b68:	e1500001 	cmp	r0, r1
    1b6c:	20400001 	subcs	r0, r0, r1
    1b70:	21822003 	orrcs	r2, r2, r3
    1b74:	e15000a1 	cmp	r0, r1, lsr #1
    1b78:	204000a1 	subcs	r0, r0, r1, lsr #1
    1b7c:	218220a3 	orrcs	r2, r2, r3, lsr #1
    1b80:	e1500121 	cmp	r0, r1, lsr #2
    1b84:	20400121 	subcs	r0, r0, r1, lsr #2
    1b88:	21822123 	orrcs	r2, r2, r3, lsr #2
    1b8c:	e15001a1 	cmp	r0, r1, lsr #3
    1b90:	204001a1 	subcs	r0, r0, r1, lsr #3
    1b94:	218221a3 	orrcs	r2, r2, r3, lsr #3
    1b98:	e3500000 	cmp	r0, #0
    1b9c:	11b03223 	lsrsne	r3, r3, #4
    1ba0:	11a01221 	lsrne	r1, r1, #4
    1ba4:	1affffef 	bne	1b68 <__udivsi3+0x58>
    1ba8:	e1a00002 	mov	r0, r2
    1bac:	e12fff1e 	bx	lr
    1bb0:	03a00001 	moveq	r0, #1
    1bb4:	13a00000 	movne	r0, #0
    1bb8:	e12fff1e 	bx	lr
    1bbc:	e3510801 	cmp	r1, #65536	@ 0x10000
    1bc0:	21a01821 	lsrcs	r1, r1, #16
    1bc4:	23a02010 	movcs	r2, #16
    1bc8:	33a02000 	movcc	r2, #0
    1bcc:	e3510c01 	cmp	r1, #256	@ 0x100
    1bd0:	21a01421 	lsrcs	r1, r1, #8
    1bd4:	22822008 	addcs	r2, r2, #8
    1bd8:	e3510010 	cmp	r1, #16
    1bdc:	21a01221 	lsrcs	r1, r1, #4
    1be0:	22822004 	addcs	r2, r2, #4
    1be4:	e3510004 	cmp	r1, #4
    1be8:	82822003 	addhi	r2, r2, #3
    1bec:	908220a1 	addls	r2, r2, r1, lsr #1
    1bf0:	e1a00230 	lsr	r0, r0, r2
    1bf4:	e12fff1e 	bx	lr
    1bf8:	e3500000 	cmp	r0, #0
    1bfc:	13e00000 	mvnne	r0, #0
    1c00:	ea000007 	b	1c24 <__aeabi_idiv0>

00001c04 <__aeabi_uidivmod>:
    1c04:	e3510000 	cmp	r1, #0
    1c08:	0afffffa 	beq	1bf8 <__udivsi3+0xe8>
    1c0c:	e92d4003 	push	{r0, r1, lr}
    1c10:	ebffffbe 	bl	1b10 <__udivsi3>
    1c14:	e8bd4006 	pop	{r1, r2, lr}
    1c18:	e0030092 	mul	r3, r2, r0
    1c1c:	e0411003 	sub	r1, r1, r3
    1c20:	e12fff1e 	bx	lr
