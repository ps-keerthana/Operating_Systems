...
0000106c <putc>:
    ...
    1074:	e24dd008 	sub	sp, sp, #8
    1078:	e50b0008 	str	r0, [fp, #-8]
    107c:	e1a03001 	mov	r3, r1
    1080:	e54b3009 	strb	r3, [fp, #-9]
    1084:	e24b3009 	sub	r3, fp, #9
    1088:	e3a02001 	mov	r2, #1
    108c:	e1a01003 	mov	r1, r3
    1090:	e51b0008 	ldr	r0, [fp, #-8]
    1094:	ebfffed2 	bl	be4 <write>
    1098:	e1a00000 	nop			@ (mov r0, r0)
    109c:	e24bd004 	sub	sp, fp, #4
    10a0:	e8bd8800 	pop	{fp, pc}

000010a4 <printint>:
    10a4:	e92d4800 	push	{fp, lr}
    10a8:	e28db004 	add	fp, sp, #4
    10ac:	e24dd030 	sub	sp, sp, #48	@ 0x30
    10b0:	e50b0028 	str	r0, [fp, #-40]	@ 0xffffffd8
    10b4:	e50b102c 	str	r1, [fp, #-44]	@ 0xffffffd4
    10b8:	e50b2030 	str	r2, [fp, #-48]	@ 0xffffffd0
    10bc:	e50b3034 	str	r3, [fp, #-52]	@ 0xffffffcc
    10c0:	e3a03000 	mov	r3, #0
    10c4:	e50b300c 	str	r3, [fp, #-12]
    10c8:	e51b3034 	ldr	r3, [fp, #-52]	@ 0xffffffcc
    10cc:	e3530000 	cmp	r3, #0
    10d0:	0a000008 	beq	10f8 <printint+0x54>
    10d4:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    10d8:	e3530000 	cmp	r3, #0
    10dc:	aa000005 	bge	10f8 <printint+0x54>
    10e0:	e3a03001 	mov	r3, #1
    10e4:	e50b300c 	str	r3, [fp, #-12]
    10e8:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    10ec:	e2633000 	rsb	r3, r3, #0
    10f0:	e50b3010 	str	r3, [fp, #-16]
    10f4:	ea000001 	b	1100 <printint+0x5c>
    10f8:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    10fc:	e50b3010 	str	r3, [fp, #-16]
    1100:	e3a03000 	mov	r3, #0
    1104:	e50b3008 	str	r3, [fp, #-8]
    1108:	e51b2030 	ldr	r2, [fp, #-48]	@ 0xffffffd0
    110c:	e51b3010 	ldr	r3, [fp, #-16]
    1110:	e1a01002 	mov	r1, r2
    1114:	e1a00003 	mov	r0, r3
    1118:	eb0001d5 	bl	1874 <__aeabi_uidivmod>
    111c:	e1a03001 	mov	r3, r1
    1120:	e1a01003 	mov	r1, r3
    1124:	e51b3008 	ldr	r3, [fp, #-8]
    1128:	e2832001 	add	r2, r3, #1
    112c:	e50b2008 	str	r2, [fp, #-8]
    1130:	e59f20a0 	ldr	r2, [pc, #160]	@ 11d8 <printint+0x134>
    1134:	e7d22001 	ldrb	r2, [r2, r1]
    1138:	e2433004 	sub	r3, r3, #4
    113c:	e083300b 	add	r3, r3, fp
    1140:	e543201c 	strb	r2, [r3, #-28]	@ 0xffffffe4
    1144:	e51b3030 	ldr	r3, [fp, #-48]	@ 0xffffffd0
    1148:	e1a01003 	mov	r1, r3
    114c:	e51b0010 	ldr	r0, [fp, #-16]
    1150:	eb00018a 	bl	1780 <__udivsi3>
    1154:	e1a03000 	mov	r3, r0
    1158:	e50b3010 	str	r3, [fp, #-16]
    115c:	e51b3010 	ldr	r3, [fp, #-16]
    1160:	e3530000 	cmp	r3, #0
    1164:	1affffe7 	bne	1108 <printint+0x64>
    1168:	e51b300c 	ldr	r3, [fp, #-12]
    116c:	e3530000 	cmp	r3, #0
    1170:	0a00000e 	beq	11b0 <printint+0x10c>
    1174:	e51b3008 	ldr	r3, [fp, #-8]
    1178:	e2832001 	add	r2, r3, #1
    117c:	e50b2008 	str	r2, [fp, #-8]
    1180:	e2433004 	sub	r3, r3, #4
    1184:	e083300b 	add	r3, r3, fp
    1188:	e3a0202d 	mov	r2, #45	@ 0x2d
    118c:	e543201c 	strb	r2, [r3, #-28]	@ 0xffffffe4
    1190:	ea000006 	b	11b0 <printint+0x10c>
    1194:	e24b2020 	sub	r2, fp, #32
    1198:	e51b3008 	ldr	r3, [fp, #-8]
    119c:	e0823003 	add	r3, r2, r3
    11a0:	e5d33000 	ldrb	r3, [r3]
    11a4:	e1a01003 	mov	r1, r3
    11a8:	e51b0028 	ldr	r0, [fp, #-40]	@ 0xffffffd8
    11ac:	ebffffae 	bl	106c <putc>
...
000011dc <printf>:
    ...
    1310:	1a00000a 	bne	1340 <printf+0x164>
    1314:	e59f30f4 	ldr	r3, [pc, #244]	@ 1410 <printf+0x234>
    1318:	e50b300c 	str	r3, [fp, #-12]
    131c:	ea000007 	b	1340 <printf+0x164>
    1320:	e51b300c 	ldr	r3, [fp, #-12]
    1324:	e5d33000 	ldrb	r3, [r3]
    1328:	e1a01003 	mov	r1, r3
    132c:	e51b0024 	ldr	r0, [fp, #-36]	@ 0xffffffdc
    1330:	ebffff4d 	bl	106c <putc>
    1334:	e51b300c 	ldr	r3, [fp, #-12]
    1338:	e2833001 	add	r3, r3, #1
    133c:	e50b300c 	str	r3, [fp, #-12]
    1340:	e51b300c 	ldr	r3, [fp, #-12]
    1344:	e5d33000 	ldrb	r3, [r3]
    1348:	e3530000 	cmp	r3, #0
    134c:	1afffff3 	bne	1320 <printf+0x144>
    1350:	ea00001d 	b	13cc <printf+0x1f0>
    1354:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    1358:	e3530063 	cmp	r3, #99	@ 0x63
    135c:	1a000009 	bne	1388 <printf+0x1ac>
    ...
    1374:	ebffff3c 	bl	106c <putc>
    1378:	e51b3018 	ldr	r3, [fp, #-24]	@ 0xffffffe8
    137c:	e2833004 	add	r3, r3, #4
    1380:	e50b3018 	str	r3, [fp, #-24]	@ 0xffffffe8
    1384:	ea000010 	b	13cc <printf+0x1f0>
    1388:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    138c:	e3530025 	cmp	r3, #37	@ 0x25
    1390:	1a000005 	bne	13ac <printf+0x1d0>
    ...
    13a4:	ebffff30 	bl	106c <putc>
    13a8:	ea000007 	b	13cc <printf+0x1f0>
    13ac:	e3a01025 	mov	r1, #37	@ 0x25
    13b0:	e51b0024 	ldr	r0, [fp, #-36]	@ 0xffffffdc
    13b4:	ebffff2c 	bl	106c <putc>
...
00001414 <free>:
    ...
    14c8:	1a00000d 	bne	1504 <free+0xf0>
    ...
    1500:	ea000003 	b	1514 <free+0x100>
    ...
    1530:	1a00000b 	bne	1564 <free+0x150>
    ...
    1554:	e5932000 	ldr	r2, [r3]
    1558:	e51b3008 	ldr	r3, [fp, #-8]
    155c:	e5832000 	str	r2, [r3]
    1560:	ea000002 	b	1570 <free+0x15c>
    1564:	e51b3008 	ldr	r3, [fp, #-8]
    1568:	e51b200c 	ldr	r2, [fp, #-12]
    156c:	e5832000 	str	r2, [r3]
    1570:	e59f2014 	ldr	r2, [pc, #20]	@ 158c <free+0x178>
    1574:	e51b3008 	ldr	r3, [fp, #-8]
    1578:	e5823000 	str	r3, [r2]
    157c:	e1a00000 	nop			@ (mov r0, r0)
    1580:	e28bd000 	add	sp, fp, #0
    1584:	e49db004 	pop	{fp}		@ (ldr fp, [sp], #4)
    1588:	e12fff1e 	bx	lr
    158c:	00001948 	.word	0x00001948

00001590 <morecore>:
    1590:	e92d4800 	push	{fp, lr}
    1594:	e28db004 	add	fp, sp, #4
    1598:	e24dd010 	sub	sp, sp, #16
    159c:	e50b0010 	str	r0, [fp, #-16]
    15a0:	e51b3010 	ldr	r3, [fp, #-16]
    15a4:	e3530a01 	cmp	r3, #4096	@ 0x1000
    15a8:	2a000001 	bcs	15b4 <morecore+0x24>
    15ac:	e3a03a01 	mov	r3, #4096	@ 0x1000
    15b0:	e50b3010 	str	r3, [fp, #-16]
    15b4:	e51b3010 	ldr	r3, [fp, #-16]
    15b8:	e1a03183 	lsl	r3, r3, #3
    15bc:	e1a00003 	mov	r0, r3
    15c0:	ebfffdfc 	bl	db8 <sbrk>
    15c4:	e50b0008 	str	r0, [fp, #-8]
    15c8:	e51b3008 	ldr	r3, [fp, #-8]
    15cc:	e3730001 	cmn	r3, #1
    15d0:	1a000001 	bne	15dc <morecore+0x4c>
    15d4:	e3a03000 	mov	r3, #0
    15d8:	ea00000a 	b	1608 <morecore+0x78>
    ...
    15f4:	e2833008 	add	r3, r3, #8
    15f8:	e1a00003 	mov	r0, r3
    15fc:	ebffff84 	bl	1414 <free>
    1600:	e59f300c 	ldr	r3, [pc, #12]	@ 1614 <morecore+0x84>
    1604:	e5933000 	ldr	r3, [r3]
    1608:	e1a00003 	mov	r0, r3
    160c:	e24bd004 	sub	sp, fp, #4
    1610:	e8bd8800 	pop	{fp, pc}
    1614:	00001948 	.word	0x00001948

00001618 <malloc>:
    1618:	e92d4800 	push	{fp, lr}
    161c:	e28db004 	add	fp, sp, #4
    1620:	e24dd018 	sub	sp, sp, #24
    1624:	e50b0018 	str	r0, [fp, #-24]	@ 0xffffffe8
    1628:	e51b3018 	ldr	r3, [fp, #-24]	@ 0xffffffe8
    162c:	e2833007 	add	r3, r3, #7
    1630:	e1a031a3 	lsr	r3, r3, #3
    1634:	e2833001 	add	r3, r3, #1
    1638:	e50b3010 	str	r3, [fp, #-16]
    163c:	e59f3134 	ldr	r3, [pc, #308]	@ 1778 <malloc+0x160>
    1640:	e5933000 	ldr	r3, [r3]
    1644:	e50b300c 	str	r3, [fp, #-12]
    1648:	e51b300c 	ldr	r3, [fp, #-12]
    164c:	e3530000 	cmp	r3, #0
    1650:	1a00000b 	bne	1684 <malloc+0x6c>
    1654:	e59f3120 	ldr	r3, [pc, #288]	@ 177c <malloc+0x164>
    1658:	e50b300c 	str	r3, [fp, #-12]
    165c:	e59f2114 	ldr	r2, [pc, #276]	@ 1778 <malloc+0x160>
    1660:	e51b300c 	ldr	r3, [fp, #-12]
    1664:	e5823000 	str	r3, [r2]
    1668:	e59f3108 	ldr	r3, [pc, #264]	@ 1778 <malloc+0x160>
    166c:	e5933000 	ldr	r3, [r3]
    1670:	e59f2104 	ldr	r2, [pc, #260]	@ 177c <malloc+0x164>
    1674:	e5823000 	str	r3, [r2]
    1678:	e59f30fc 	ldr	r3, [pc, #252]	@ 177c <malloc+0x164>
    ...
    1708:	e59f2068 	ldr	r2, [pc, #104]	@ 1778 <malloc+0x160>
    170c:	e51b300c 	ldr	r3, [fp, #-12]
    1710:	e5823000 	str	r3, [r2]
    1714:	e51b3008 	ldr	r3, [fp, #-8]
    1718:	e2833008 	add	r3, r3, #8
    171c:	ea000012 	b	176c <malloc+0x154>
    1720:	e59f3050 	ldr	r3, [pc, #80]	@ 1778 <malloc+0x160>
    1724:	e5933000 	ldr	r3, [r3]
    1728:	e51b2008 	ldr	r2, [fp, #-8]
    172c:	e1520003 	cmp	r2, r3
    1730:	1a000007 	bne	1754 <malloc+0x13c>
    1734:	e51b0010 	ldr	r0, [fp, #-16]
    1738:	ebffff94 	bl	1590 <morecore>
    173c:	e50b0008 	str	r0, [fp, #-8]
    1740:	e51b3008 	ldr	r3, [fp, #-8]
    1744:	e3530000 	cmp	r3, #0
    1748:	1a000001 	bne	1754 <malloc+0x13c>
    174c:	e3a03000 	mov	r3, #0
    1750:	ea000005 	b	176c <malloc+0x154>
    1754:	e51b3008 	ldr	r3, [fp, #-8]
    1758:	e50b300c 	str	r3, [fp, #-12]
    175c:	e51b3008 	ldr	r3, [fp, #-8]
    1760:	e5933000 	ldr	r3, [r3]
    1764:	e50b3008 	str	r3, [fp, #-8]
    1768:	eaffffc8 	b	1690 <malloc+0x78>
    176c:	e1a00003 	mov	r0, r3
    1770:	e24bd004 	sub	sp, fp, #4
    1774:	e8bd8800 	pop	{fp, pc}
    1778:	00001948 	.word	0x00001948
    177c:	00001940 	.word	0x00001940

00001780 <__udivsi3>:
    1780:	e2512001 	subs	r2, r1, #1
    1784:	012fff1e 	bxeq	lr
    1788:	3a000036 	bcc	1868 <__udivsi3+0xe8>
    178c:	e1500001 	cmp	r0, r1
    1790:	9a000022 	bls	1820 <__udivsi3+0xa0>
    1794:	e1110002 	tst	r1, r2
    1798:	0a000023 	beq	182c <__udivsi3+0xac>
    179c:	e311020e 	tst	r1, #-536870912	@ 0xe0000000
    17a0:	01a01181 	lsleq	r1, r1, #3
    17a4:	03a03008 	moveq	r3, #8
    17a8:	13a03001 	movne	r3, #1
    17ac:	e3510201 	cmp	r1, #268435456	@ 0x10000000
    17b0:	31510000 	cmpcc	r1, r0
    17b4:	31a01201 	lslcc	r1, r1, #4
    17b8:	31a03203 	lslcc	r3, r3, #4
    17bc:	3afffffa 	bcc	17ac <__udivsi3+0x2c>
    17c0:	e3510102 	cmp	r1, #-2147483648	@ 0x80000000
    17c4:	31510000 	cmpcc	r1, r0
    17c8:	31a01081 	lslcc	r1, r1, #1
    17cc:	31a03083 	lslcc	r3, r3, #1
    17d0:	3afffffa 	bcc	17c0 <__udivsi3+0x40>
    17d4:	e3a02000 	mov	r2, #0
    17d8:	e1500001 	cmp	r0, r1
    17dc:	20400001 	subcs	r0, r0, r1
    17e0:	21822003 	orrcs	r2, r2, r3
    17e4:	e15000a1 	cmp	r0, r1, lsr #1
    17e8:	204000a1 	subcs	r0, r0, r1, lsr #1
    17ec:	218220a3 	orrcs	r2, r2, r3, lsr #1
    17f0:	e1500121 	cmp	r0, r1, lsr #2
    17f4:	20400121 	subcs	r0, r0, r1, lsr #2
    17f8:	21822123 	orrcs	r2, r2, r3, lsr #2
    17fc:	e15001a1 	cmp	r0, r1, lsr #3
    1800:	204001a1 	subcs	r0, r0, r1, lsr #3
    1804:	218221a3 	orrcs	r2, r2, r3, lsr #3
    1808:	e3500000 	cmp	r0, #0
    180c:	11b03223 	lsrsne	r3, r3, #4
    1810:	11a01221 	lsrne	r1, r1, #4
    1814:	1affffef 	bne	17d8 <__udivsi3+0x58>
    1818:	e1a00002 	mov	r0, r2
    181c:	e12fff1e 	bx	lr
    1820:	03a00001 	moveq	r0, #1
    1824:	13a00000 	movne	r0, #0
    1828:	e12fff1e 	bx	lr
    182c:	e3510801 	cmp	r1, #65536	@ 0x10000
    1830:	21a01821 	lsrcs	r1, r1, #16
    1834:	23a02010 	movcs	r2, #16
    1838:	33a02000 	movcc	r2, #0
    183c:	e3510c01 	cmp	r1, #256	@ 0x100
    1840:	21a01421 	lsrcs	r1, r1, #8
    1844:	22822008 	addcs	r2, r2, #8
    1848:	e3510010 	cmp	r1, #16
    184c:	21a01221 	lsrcs	r1, r1, #4
    1850:	22822004 	addcs	r2, r2, #4
    1854:	e3510004 	cmp	r1, #4
    1858:	82822003 	addhi	r2, r2, #3
    185c:	908220a1 	addls	r2, r2, r1, lsr #1
    1860:	e1a00230 	lsr	r0, r0, r2
    1864:	e12fff1e 	bx	lr
    1868:	e3500000 	cmp	r0, #0
    186c:	13e00000 	mvnne	r0, #0
    1870:	ea000007 	b	1894 <__aeabi_idiv0>

00001874 <__aeabi_uidivmod>:
    1874:	e3510000 	cmp	r1, #0
    1878:	0afffffa 	beq	1868 <__udivsi3+0xe8>
    187c:	e92d4003 	push	{r0, r1, lr}
    1880:	ebffffbe 	bl	1780 <__udivsi3>
    1884:	e8bd4006 	pop	{r1, r2, lr}
    1888:	e0030092 	mul	r3, r2, r0
    188c:	e0411003 	sub	r1, r1, r3
    1890:	e12fff1e 	bx	lr

00001894 <__aeabi_idiv0>:
    1894:	e12fff1e 	bx	lr
