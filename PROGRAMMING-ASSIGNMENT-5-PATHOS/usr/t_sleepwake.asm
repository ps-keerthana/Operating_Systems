...
00001010 <putc>:
    ...
    1020:	e1a03001 	mov	r3, r1
    1024:	e54b3009 	strb	r3, [fp, #-9]
    1028:	e24b3009 	sub	r3, fp, #9
    102c:	e3a02001 	mov	r2, #1
    1030:	e1a01003 	mov	r1, r3
    1034:	e51b0008 	ldr	r0, [fp, #-8]
    1038:	ebfffed2 	bl	b88 <write>
...
00001048 <printint>:
    ...
    1050:	e24dd030 	sub	sp, sp, #48	@ 0x30
    1054:	e50b0028 	str	r0, [fp, #-40]	@ 0xffffffd8
    1058:	e50b102c 	str	r1, [fp, #-44]	@ 0xffffffd4
    105c:	e50b2030 	str	r2, [fp, #-48]	@ 0xffffffd0
    1060:	e50b3034 	str	r3, [fp, #-52]	@ 0xffffffcc
    1064:	e3a03000 	mov	r3, #0
    1068:	e50b300c 	str	r3, [fp, #-12]
    106c:	e51b3034 	ldr	r3, [fp, #-52]	@ 0xffffffcc
    1070:	e3530000 	cmp	r3, #0
    1074:	0a000008 	beq	109c <printint+0x54>
    1078:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    107c:	e3530000 	cmp	r3, #0
    1080:	aa000005 	bge	109c <printint+0x54>
    1084:	e3a03001 	mov	r3, #1
    1088:	e50b300c 	str	r3, [fp, #-12]
    108c:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    1090:	e2633000 	rsb	r3, r3, #0
    1094:	e50b3010 	str	r3, [fp, #-16]
    1098:	ea000001 	b	10a4 <printint+0x5c>
    109c:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    10a0:	e50b3010 	str	r3, [fp, #-16]
    10a4:	e3a03000 	mov	r3, #0
    10a8:	e50b3008 	str	r3, [fp, #-8]
    10ac:	e51b2030 	ldr	r2, [fp, #-48]	@ 0xffffffd0
    10b0:	e51b3010 	ldr	r3, [fp, #-16]
    10b4:	e1a01002 	mov	r1, r2
    10b8:	e1a00003 	mov	r0, r3
    10bc:	eb0001d5 	bl	1818 <__aeabi_uidivmod>
    10c0:	e1a03001 	mov	r3, r1
    10c4:	e1a01003 	mov	r1, r3
    10c8:	e51b3008 	ldr	r3, [fp, #-8]
    10cc:	e2832001 	add	r2, r3, #1
    10d0:	e50b2008 	str	r2, [fp, #-8]
    10d4:	e59f20a0 	ldr	r2, [pc, #160]	@ 117c <printint+0x134>
    10d8:	e7d22001 	ldrb	r2, [r2, r1]
    10dc:	e2433004 	sub	r3, r3, #4
    10e0:	e083300b 	add	r3, r3, fp
    10e4:	e543201c 	strb	r2, [r3, #-28]	@ 0xffffffe4
    10e8:	e51b3030 	ldr	r3, [fp, #-48]	@ 0xffffffd0
    10ec:	e1a01003 	mov	r1, r3
    10f0:	e51b0010 	ldr	r0, [fp, #-16]
    10f4:	eb00018a 	bl	1724 <__udivsi3>
    10f8:	e1a03000 	mov	r3, r0
    10fc:	e50b3010 	str	r3, [fp, #-16]
    1100:	e51b3010 	ldr	r3, [fp, #-16]
    1104:	e3530000 	cmp	r3, #0
    1108:	1affffe7 	bne	10ac <printint+0x64>
    110c:	e51b300c 	ldr	r3, [fp, #-12]
    1110:	e3530000 	cmp	r3, #0
    1114:	0a00000e 	beq	1154 <printint+0x10c>
    ...
    112c:	e3a0202d 	mov	r2, #45	@ 0x2d
    1130:	e543201c 	strb	r2, [r3, #-28]	@ 0xffffffe4
    1134:	ea000006 	b	1154 <printint+0x10c>
    1138:	e24b2020 	sub	r2, fp, #32
    113c:	e51b3008 	ldr	r3, [fp, #-8]
    1140:	e0823003 	add	r3, r2, r3
    1144:	e5d33000 	ldrb	r3, [r3]
    1148:	e1a01003 	mov	r1, r3
    114c:	e51b0028 	ldr	r0, [fp, #-40]	@ 0xffffffd8
    1150:	ebffffae 	bl	1010 <putc>
...
00001180 <printf>:
    ...
    12b4:	1a00000a 	bne	12e4 <printf+0x164>
    12b8:	e59f30f4 	ldr	r3, [pc, #244]	@ 13b4 <printf+0x234>
    12bc:	e50b300c 	str	r3, [fp, #-12]
    12c0:	ea000007 	b	12e4 <printf+0x164>
    12c4:	e51b300c 	ldr	r3, [fp, #-12]
    12c8:	e5d33000 	ldrb	r3, [r3]
    12cc:	e1a01003 	mov	r1, r3
    12d0:	e51b0024 	ldr	r0, [fp, #-36]	@ 0xffffffdc
    12d4:	ebffff4d 	bl	1010 <putc>
    ...
    12f0:	1afffff3 	bne	12c4 <printf+0x144>
    12f4:	ea00001d 	b	1370 <printf+0x1f0>
    12f8:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    12fc:	e3530063 	cmp	r3, #99	@ 0x63
    1300:	1a000009 	bne	132c <printf+0x1ac>
    ...
    1348:	ebffff30 	bl	1010 <putc>
    134c:	ea000007 	b	1370 <printf+0x1f0>
    1350:	e3a01025 	mov	r1, #37	@ 0x25
    1354:	e51b0024 	ldr	r0, [fp, #-36]	@ 0xffffffdc
    1358:	ebffff2c 	bl	1010 <putc>
    ...
    136c:	ebffff27 	bl	1010 <putc>
    1370:	e3a03000 	mov	r3, #0
    1374:	e50b3014 	str	r3, [fp, #-20]	@ 0xffffffec
    1378:	e51b3010 	ldr	r3, [fp, #-16]
    137c:	e2833001 	add	r3, r3, #1
    1380:	e50b3010 	str	r3, [fp, #-16]
...
000013b8 <free>:
    ...
    14a4:	ea000003 	b	14b8 <free+0x100>
    ...
    14d4:	1a00000b 	bne	1508 <free+0x150>
    14d8:	e51b3008 	ldr	r3, [fp, #-8]
    14dc:	e5932004 	ldr	r2, [r3, #4]
    ...
    1504:	ea000002 	b	1514 <free+0x15c>
    1508:	e51b3008 	ldr	r3, [fp, #-8]
    150c:	e51b200c 	ldr	r2, [fp, #-12]
    1510:	e5832000 	str	r2, [r3]
    1514:	e59f2014 	ldr	r2, [pc, #20]	@ 1530 <free+0x178>
    1518:	e51b3008 	ldr	r3, [fp, #-8]
    151c:	e5823000 	str	r3, [r2]
    1520:	e1a00000 	nop			@ (mov r0, r0)
    1524:	e28bd000 	add	sp, fp, #0
    1528:	e49db004 	pop	{fp}		@ (ldr fp, [sp], #4)
    152c:	e12fff1e 	bx	lr
    1530:	00001894 	.word	0x00001894

00001534 <morecore>:
    1534:	e92d4800 	push	{fp, lr}
    1538:	e28db004 	add	fp, sp, #4
    153c:	e24dd010 	sub	sp, sp, #16
    1540:	e50b0010 	str	r0, [fp, #-16]
    1544:	e51b3010 	ldr	r3, [fp, #-16]
    1548:	e3530a01 	cmp	r3, #4096	@ 0x1000
    154c:	2a000001 	bcs	1558 <morecore+0x24>
    1550:	e3a03a01 	mov	r3, #4096	@ 0x1000
    1554:	e50b3010 	str	r3, [fp, #-16]
    1558:	e51b3010 	ldr	r3, [fp, #-16]
    155c:	e1a03183 	lsl	r3, r3, #3
    1560:	e1a00003 	mov	r0, r3
    1564:	ebfffdfc 	bl	d5c <sbrk>
    1568:	e50b0008 	str	r0, [fp, #-8]
    156c:	e51b3008 	ldr	r3, [fp, #-8]
    1570:	e3730001 	cmn	r3, #1
    1574:	1a000001 	bne	1580 <morecore+0x4c>
    1578:	e3a03000 	mov	r3, #0
    157c:	ea00000a 	b	15ac <morecore+0x78>
    ...
    15a0:	ebffff84 	bl	13b8 <free>
    15a4:	e59f300c 	ldr	r3, [pc, #12]	@ 15b8 <morecore+0x84>
    15a8:	e5933000 	ldr	r3, [r3]
    15ac:	e1a00003 	mov	r0, r3
    15b0:	e24bd004 	sub	sp, fp, #4
    15b4:	e8bd8800 	pop	{fp, pc}
    15b8:	00001894 	.word	0x00001894

000015bc <malloc>:
    15bc:	e92d4800 	push	{fp, lr}
    15c0:	e28db004 	add	fp, sp, #4
    15c4:	e24dd018 	sub	sp, sp, #24
    15c8:	e50b0018 	str	r0, [fp, #-24]	@ 0xffffffe8
    15cc:	e51b3018 	ldr	r3, [fp, #-24]	@ 0xffffffe8
    15d0:	e2833007 	add	r3, r3, #7
    15d4:	e1a031a3 	lsr	r3, r3, #3
    15d8:	e2833001 	add	r3, r3, #1
    15dc:	e50b3010 	str	r3, [fp, #-16]
    15e0:	e59f3134 	ldr	r3, [pc, #308]	@ 171c <malloc+0x160>
    15e4:	e5933000 	ldr	r3, [r3]
    15e8:	e50b300c 	str	r3, [fp, #-12]
    15ec:	e51b300c 	ldr	r3, [fp, #-12]
    15f0:	e3530000 	cmp	r3, #0
    15f4:	1a00000b 	bne	1628 <malloc+0x6c>
    15f8:	e59f3120 	ldr	r3, [pc, #288]	@ 1720 <malloc+0x164>
    15fc:	e50b300c 	str	r3, [fp, #-12]
    1600:	e59f2114 	ldr	r2, [pc, #276]	@ 171c <malloc+0x160>
    1604:	e51b300c 	ldr	r3, [fp, #-12]
    1608:	e5823000 	str	r3, [r2]
    160c:	e59f3108 	ldr	r3, [pc, #264]	@ 171c <malloc+0x160>
    1610:	e5933000 	ldr	r3, [r3]
    1614:	e59f2104 	ldr	r2, [pc, #260]	@ 1720 <malloc+0x164>
    1618:	e5823000 	str	r3, [r2]
    161c:	e59f30fc 	ldr	r3, [pc, #252]	@ 1720 <malloc+0x164>
    1620:	e3a02000 	mov	r2, #0
    1624:	e5832004 	str	r2, [r3, #4]
    1628:	e51b300c 	ldr	r3, [fp, #-12]
    162c:	e5933000 	ldr	r3, [r3]
    1630:	e50b3008 	str	r3, [fp, #-8]
    1634:	e51b3008 	ldr	r3, [fp, #-8]
    1638:	e5933004 	ldr	r3, [r3, #4]
    163c:	e51b2010 	ldr	r2, [fp, #-16]
    1640:	e1520003 	cmp	r2, r3
    1644:	8a00001e 	bhi	16c4 <malloc+0x108>
    1648:	e51b3008 	ldr	r3, [fp, #-8]
    164c:	e5933004 	ldr	r3, [r3, #4]
    1650:	e51b2010 	ldr	r2, [fp, #-16]
    1654:	e1520003 	cmp	r2, r3
    1658:	1a000004 	bne	1670 <malloc+0xb4>
    165c:	e51b3008 	ldr	r3, [fp, #-8]
    1660:	e5932000 	ldr	r2, [r3]
    1664:	e51b300c 	ldr	r3, [fp, #-12]
    1668:	e5832000 	str	r2, [r3]
    166c:	ea00000e 	b	16ac <malloc+0xf0>
    1670:	e51b3008 	ldr	r3, [fp, #-8]
    1674:	e5932004 	ldr	r2, [r3, #4]
    1678:	e51b3010 	ldr	r3, [fp, #-16]
    167c:	e0422003 	sub	r2, r2, r3
    1680:	e51b3008 	ldr	r3, [fp, #-8]
    1684:	e5832004 	str	r2, [r3, #4]
    1688:	e51b3008 	ldr	r3, [fp, #-8]
    168c:	e5933004 	ldr	r3, [r3, #4]
    1690:	e1a03183 	lsl	r3, r3, #3
    1694:	e51b2008 	ldr	r2, [fp, #-8]
    1698:	e0823003 	add	r3, r2, r3
    169c:	e50b3008 	str	r3, [fp, #-8]
    16a0:	e51b3008 	ldr	r3, [fp, #-8]
    16a4:	e51b2010 	ldr	r2, [fp, #-16]
    16a8:	e5832004 	str	r2, [r3, #4]
    16ac:	e59f2068 	ldr	r2, [pc, #104]	@ 171c <malloc+0x160>
    16b0:	e51b300c 	ldr	r3, [fp, #-12]
    16b4:	e5823000 	str	r3, [r2]
    16b8:	e51b3008 	ldr	r3, [fp, #-8]
    16bc:	e2833008 	add	r3, r3, #8
    16c0:	ea000012 	b	1710 <malloc+0x154>
    16c4:	e59f3050 	ldr	r3, [pc, #80]	@ 171c <malloc+0x160>
    16c8:	e5933000 	ldr	r3, [r3]
    16cc:	e51b2008 	ldr	r2, [fp, #-8]
    16d0:	e1520003 	cmp	r2, r3
    16d4:	1a000007 	bne	16f8 <malloc+0x13c>
    16d8:	e51b0010 	ldr	r0, [fp, #-16]
    16dc:	ebffff94 	bl	1534 <morecore>
    16e0:	e50b0008 	str	r0, [fp, #-8]
    16e4:	e51b3008 	ldr	r3, [fp, #-8]
    16e8:	e3530000 	cmp	r3, #0
    16ec:	1a000001 	bne	16f8 <malloc+0x13c>
    16f0:	e3a03000 	mov	r3, #0
    16f4:	ea000005 	b	1710 <malloc+0x154>
    16f8:	e51b3008 	ldr	r3, [fp, #-8]
    16fc:	e50b300c 	str	r3, [fp, #-12]
    1700:	e51b3008 	ldr	r3, [fp, #-8]
    1704:	e5933000 	ldr	r3, [r3]
    1708:	e50b3008 	str	r3, [fp, #-8]
    170c:	eaffffc8 	b	1634 <malloc+0x78>
    1710:	e1a00003 	mov	r0, r3
    1714:	e24bd004 	sub	sp, fp, #4
    1718:	e8bd8800 	pop	{fp, pc}
    171c:	00001894 	.word	0x00001894
    1720:	0000188c 	.word	0x0000188c

00001724 <__udivsi3>:
    1724:	e2512001 	subs	r2, r1, #1
    1728:	012fff1e 	bxeq	lr
    172c:	3a000036 	bcc	180c <__udivsi3+0xe8>
    1730:	e1500001 	cmp	r0, r1
    1734:	9a000022 	bls	17c4 <__udivsi3+0xa0>
    1738:	e1110002 	tst	r1, r2
    173c:	0a000023 	beq	17d0 <__udivsi3+0xac>
    1740:	e311020e 	tst	r1, #-536870912	@ 0xe0000000
    1744:	01a01181 	lsleq	r1, r1, #3
    1748:	03a03008 	moveq	r3, #8
    174c:	13a03001 	movne	r3, #1
    1750:	e3510201 	cmp	r1, #268435456	@ 0x10000000
    1754:	31510000 	cmpcc	r1, r0
    1758:	31a01201 	lslcc	r1, r1, #4
    175c:	31a03203 	lslcc	r3, r3, #4
    1760:	3afffffa 	bcc	1750 <__udivsi3+0x2c>
    1764:	e3510102 	cmp	r1, #-2147483648	@ 0x80000000
    1768:	31510000 	cmpcc	r1, r0
    176c:	31a01081 	lslcc	r1, r1, #1
    1770:	31a03083 	lslcc	r3, r3, #1
    1774:	3afffffa 	bcc	1764 <__udivsi3+0x40>
    1778:	e3a02000 	mov	r2, #0
    177c:	e1500001 	cmp	r0, r1
    1780:	20400001 	subcs	r0, r0, r1
    1784:	21822003 	orrcs	r2, r2, r3
    1788:	e15000a1 	cmp	r0, r1, lsr #1
    178c:	204000a1 	subcs	r0, r0, r1, lsr #1
    1790:	218220a3 	orrcs	r2, r2, r3, lsr #1
    1794:	e1500121 	cmp	r0, r1, lsr #2
    1798:	20400121 	subcs	r0, r0, r1, lsr #2
    179c:	21822123 	orrcs	r2, r2, r3, lsr #2
    17a0:	e15001a1 	cmp	r0, r1, lsr #3
    17a4:	204001a1 	subcs	r0, r0, r1, lsr #3
    17a8:	218221a3 	orrcs	r2, r2, r3, lsr #3
    17ac:	e3500000 	cmp	r0, #0
    17b0:	11b03223 	lsrsne	r3, r3, #4
    17b4:	11a01221 	lsrne	r1, r1, #4
    17b8:	1affffef 	bne	177c <__udivsi3+0x58>
    17bc:	e1a00002 	mov	r0, r2
    17c0:	e12fff1e 	bx	lr
    17c4:	03a00001 	moveq	r0, #1
    17c8:	13a00000 	movne	r0, #0
    17cc:	e12fff1e 	bx	lr
    17d0:	e3510801 	cmp	r1, #65536	@ 0x10000
    17d4:	21a01821 	lsrcs	r1, r1, #16
    17d8:	23a02010 	movcs	r2, #16
    17dc:	33a02000 	movcc	r2, #0
    17e0:	e3510c01 	cmp	r1, #256	@ 0x100
    17e4:	21a01421 	lsrcs	r1, r1, #8
    17e8:	22822008 	addcs	r2, r2, #8
    17ec:	e3510010 	cmp	r1, #16
    17f0:	21a01221 	lsrcs	r1, r1, #4
    17f4:	22822004 	addcs	r2, r2, #4
    17f8:	e3510004 	cmp	r1, #4
    17fc:	82822003 	addhi	r2, r2, #3
    1800:	908220a1 	addls	r2, r2, r1, lsr #1
    1804:	e1a00230 	lsr	r0, r0, r2
    1808:	e12fff1e 	bx	lr
    180c:	e3500000 	cmp	r0, #0
    1810:	13e00000 	mvnne	r0, #0
    1814:	ea000007 	b	1838 <__aeabi_idiv0>

00001818 <__aeabi_uidivmod>:
    1818:	e3510000 	cmp	r1, #0
    181c:	0afffffa 	beq	180c <__udivsi3+0xe8>
    1820:	e92d4003 	push	{r0, r1, lr}
    1824:	ebffffbe 	bl	1724 <__udivsi3>
    1828:	e8bd4006 	pop	{r1, r2, lr}
    182c:	e0030092 	mul	r3, r2, r0
    1830:	e0411003 	sub	r1, r1, r3
    1834:	e12fff1e 	bx	lr

00001838 <__aeabi_idiv0>:
    1838:	e12fff1e 	bx	lr
