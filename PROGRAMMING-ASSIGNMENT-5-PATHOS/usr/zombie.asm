...
00000fc4 <putc>:
     fc4:	e92d4800 	push	{fp, lr}
     fc8:	e28db004 	add	fp, sp, #4
     fcc:	e24dd008 	sub	sp, sp, #8
     fd0:	e50b0008 	str	r0, [fp, #-8]
     fd4:	e1a03001 	mov	r3, r1
     fd8:	e54b3009 	strb	r3, [fp, #-9]
     fdc:	e24b3009 	sub	r3, fp, #9
     fe0:	e3a02001 	mov	r2, #1
     fe4:	e1a01003 	mov	r1, r3
     fe8:	e51b0008 	ldr	r0, [fp, #-8]
     fec:	ebfffed2 	bl	b3c <write>
...
00000ffc <printint>:
    ...
    1004:	e24dd030 	sub	sp, sp, #48	@ 0x30
    1008:	e50b0028 	str	r0, [fp, #-40]	@ 0xffffffd8
    100c:	e50b102c 	str	r1, [fp, #-44]	@ 0xffffffd4
    1010:	e50b2030 	str	r2, [fp, #-48]	@ 0xffffffd0
    1014:	e50b3034 	str	r3, [fp, #-52]	@ 0xffffffcc
    1018:	e3a03000 	mov	r3, #0
    101c:	e50b300c 	str	r3, [fp, #-12]
    1020:	e51b3034 	ldr	r3, [fp, #-52]	@ 0xffffffcc
    1024:	e3530000 	cmp	r3, #0
    1028:	0a000008 	beq	1050 <printint+0x54>
    102c:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    1030:	e3530000 	cmp	r3, #0
    1034:	aa000005 	bge	1050 <printint+0x54>
    1038:	e3a03001 	mov	r3, #1
    103c:	e50b300c 	str	r3, [fp, #-12]
    1040:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    1044:	e2633000 	rsb	r3, r3, #0
    1048:	e50b3010 	str	r3, [fp, #-16]
    104c:	ea000001 	b	1058 <printint+0x5c>
    1050:	e51b302c 	ldr	r3, [fp, #-44]	@ 0xffffffd4
    1054:	e50b3010 	str	r3, [fp, #-16]
    1058:	e3a03000 	mov	r3, #0
    105c:	e50b3008 	str	r3, [fp, #-8]
    1060:	e51b2030 	ldr	r2, [fp, #-48]	@ 0xffffffd0
    1064:	e51b3010 	ldr	r3, [fp, #-16]
    1068:	e1a01002 	mov	r1, r2
    106c:	e1a00003 	mov	r0, r3
    1070:	eb0001d5 	bl	17cc <__aeabi_uidivmod>
    1074:	e1a03001 	mov	r3, r1
    1078:	e1a01003 	mov	r1, r3
    107c:	e51b3008 	ldr	r3, [fp, #-8]
    1080:	e2832001 	add	r2, r3, #1
    1084:	e50b2008 	str	r2, [fp, #-8]
    1088:	e59f20a0 	ldr	r2, [pc, #160]	@ 1130 <printint+0x134>
    108c:	e7d22001 	ldrb	r2, [r2, r1]
    1090:	e2433004 	sub	r3, r3, #4
    1094:	e083300b 	add	r3, r3, fp
    1098:	e543201c 	strb	r2, [r3, #-28]	@ 0xffffffe4
    109c:	e51b3030 	ldr	r3, [fp, #-48]	@ 0xffffffd0
    10a0:	e1a01003 	mov	r1, r3
    10a4:	e51b0010 	ldr	r0, [fp, #-16]
    10a8:	eb00018a 	bl	16d8 <__udivsi3>
    10ac:	e1a03000 	mov	r3, r0
    10b0:	e50b3010 	str	r3, [fp, #-16]
    10b4:	e51b3010 	ldr	r3, [fp, #-16]
    10b8:	e3530000 	cmp	r3, #0
    10bc:	1affffe7 	bne	1060 <printint+0x64>
    10c0:	e51b300c 	ldr	r3, [fp, #-12]
    10c4:	e3530000 	cmp	r3, #0
    10c8:	0a00000e 	beq	1108 <printint+0x10c>
    10cc:	e51b3008 	ldr	r3, [fp, #-8]
    10d0:	e2832001 	add	r2, r3, #1
    10d4:	e50b2008 	str	r2, [fp, #-8]
    10d8:	e2433004 	sub	r3, r3, #4
    10dc:	e083300b 	add	r3, r3, fp
    10e0:	e3a0202d 	mov	r2, #45	@ 0x2d
    10e4:	e543201c 	strb	r2, [r3, #-28]	@ 0xffffffe4
    10e8:	ea000006 	b	1108 <printint+0x10c>
    10ec:	e24b2020 	sub	r2, fp, #32
    10f0:	e51b3008 	ldr	r3, [fp, #-8]
    10f4:	e0823003 	add	r3, r2, r3
    10f8:	e5d33000 	ldrb	r3, [r3]
    10fc:	e1a01003 	mov	r1, r3
    1100:	e51b0028 	ldr	r0, [fp, #-40]	@ 0xffffffd8
    1104:	ebffffae 	bl	fc4 <putc>
    1108:	e51b3008 	ldr	r3, [fp, #-8]
    110c:	e2433001 	sub	r3, r3, #1
    1110:	e50b3008 	str	r3, [fp, #-8]
    1114:	e51b3008 	ldr	r3, [fp, #-8]
    1118:	e3530000 	cmp	r3, #0
    111c:	aafffff2 	bge	10ec <printint+0xf0>
    1120:	e1a00000 	nop			@ (mov r0, r0)
    1124:	e1a00000 	nop			@ (mov r0, r0)
    1128:	e24bd004 	sub	sp, fp, #4
    112c:	e8bd8800 	pop	{fp, pc}
    1130:	000017f8 	.word	0x000017f8

00001134 <printf>:
    1134:	e92d000e 	push	{r1, r2, r3}
    1138:	e92d4800 	push	{fp, lr}
    113c:	e28db004 	add	fp, sp, #4
    1140:	e24dd024 	sub	sp, sp, #36	@ 0x24
    1144:	e50b0024 	str	r0, [fp, #-36]	@ 0xffffffdc
    1148:	e3a03000 	mov	r3, #0
    114c:	e50b3014 	str	r3, [fp, #-20]	@ 0xffffffec
    1150:	e28b3008 	add	r3, fp, #8
    1154:	e50b3018 	str	r3, [fp, #-24]	@ 0xffffffe8
    1158:	e3a03000 	mov	r3, #0
    115c:	e50b3010 	str	r3, [fp, #-16]
    1160:	ea000074 	b	1338 <printf+0x204>
    1164:	e59b2004 	ldr	r2, [fp, #4]
    1168:	e51b3010 	ldr	r3, [fp, #-16]
    116c:	e0823003 	add	r3, r2, r3
    1170:	e5d33000 	ldrb	r3, [r3]
    1174:	e50b301c 	str	r3, [fp, #-28]	@ 0xffffffe4
    1178:	e51b3014 	ldr	r3, [fp, #-20]	@ 0xffffffec
    117c:	e3530000 	cmp	r3, #0
    1180:	1a00000b 	bne	11b4 <printf+0x80>
    1184:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    1188:	e3530025 	cmp	r3, #37	@ 0x25
    118c:	1a000002 	bne	119c <printf+0x68>
    1190:	e3a03025 	mov	r3, #37	@ 0x25
    1194:	e50b3014 	str	r3, [fp, #-20]	@ 0xffffffec
    1198:	ea000063 	b	132c <printf+0x1f8>
    ...
    1268:	1a00000a 	bne	1298 <printf+0x164>
    126c:	e59f30f4 	ldr	r3, [pc, #244]	@ 1368 <printf+0x234>
    1270:	e50b300c 	str	r3, [fp, #-12]
    1274:	ea000007 	b	1298 <printf+0x164>
    1278:	e51b300c 	ldr	r3, [fp, #-12]
    127c:	e5d33000 	ldrb	r3, [r3]
    1280:	e1a01003 	mov	r1, r3
    1284:	e51b0024 	ldr	r0, [fp, #-36]	@ 0xffffffdc
    1288:	ebffff4d 	bl	fc4 <putc>
    ...
    12a4:	1afffff3 	bne	1278 <printf+0x144>
    12a8:	ea00001d 	b	1324 <printf+0x1f0>
    12ac:	e51b301c 	ldr	r3, [fp, #-28]	@ 0xffffffe4
    12b0:	e3530063 	cmp	r3, #99	@ 0x63
    12b4:	1a000009 	bne	12e0 <printf+0x1ac>
    ...
    12fc:	ebffff30 	bl	fc4 <putc>
    1300:	ea000007 	b	1324 <printf+0x1f0>
    1304:	e3a01025 	mov	r1, #37	@ 0x25
    1308:	e51b0024 	ldr	r0, [fp, #-36]	@ 0xffffffdc
    130c:	ebffff2c 	bl	fc4 <putc>
...
0000136c <free>:
    ...
    144c:	e5932000 	ldr	r2, [r3]
    1450:	e51b300c 	ldr	r3, [fp, #-12]
    1454:	e5832000 	str	r2, [r3]
    1458:	ea000003 	b	146c <free+0x100>
    ...
    1488:	1a00000b 	bne	14bc <free+0x150>
    ...
    14b8:	ea000002 	b	14c8 <free+0x15c>
    14bc:	e51b3008 	ldr	r3, [fp, #-8]
    14c0:	e51b200c 	ldr	r2, [fp, #-12]
    14c4:	e5832000 	str	r2, [r3]
    14c8:	e59f2014 	ldr	r2, [pc, #20]	@ 14e4 <free+0x178>
    14cc:	e51b3008 	ldr	r3, [fp, #-8]
    14d0:	e5823000 	str	r3, [r2]
    14d4:	e1a00000 	nop			@ (mov r0, r0)
    14d8:	e28bd000 	add	sp, fp, #0
    14dc:	e49db004 	pop	{fp}		@ (ldr fp, [sp], #4)
    14e0:	e12fff1e 	bx	lr
    14e4:	00001814 	.word	0x00001814

000014e8 <morecore>:
    14e8:	e92d4800 	push	{fp, lr}
    14ec:	e28db004 	add	fp, sp, #4
    14f0:	e24dd010 	sub	sp, sp, #16
    14f4:	e50b0010 	str	r0, [fp, #-16]
    14f8:	e51b3010 	ldr	r3, [fp, #-16]
    14fc:	e3530a01 	cmp	r3, #4096	@ 0x1000
    1500:	2a000001 	bcs	150c <morecore+0x24>
    1504:	e3a03a01 	mov	r3, #4096	@ 0x1000
    1508:	e50b3010 	str	r3, [fp, #-16]
    150c:	e51b3010 	ldr	r3, [fp, #-16]
    1510:	e1a03183 	lsl	r3, r3, #3
    1514:	e1a00003 	mov	r0, r3
    1518:	ebfffdfc 	bl	d10 <sbrk>
    151c:	e50b0008 	str	r0, [fp, #-8]
    1520:	e51b3008 	ldr	r3, [fp, #-8]
    1524:	e3730001 	cmn	r3, #1
    1528:	1a000001 	bne	1534 <morecore+0x4c>
    152c:	e3a03000 	mov	r3, #0
    1530:	ea00000a 	b	1560 <morecore+0x78>
    ...
    154c:	e2833008 	add	r3, r3, #8
    1550:	e1a00003 	mov	r0, r3
    1554:	ebffff84 	bl	136c <free>
    1558:	e59f300c 	ldr	r3, [pc, #12]	@ 156c <morecore+0x84>
    155c:	e5933000 	ldr	r3, [r3]
    1560:	e1a00003 	mov	r0, r3
    1564:	e24bd004 	sub	sp, fp, #4
    1568:	e8bd8800 	pop	{fp, pc}
    156c:	00001814 	.word	0x00001814

00001570 <malloc>:
    1570:	e92d4800 	push	{fp, lr}
    1574:	e28db004 	add	fp, sp, #4
    1578:	e24dd018 	sub	sp, sp, #24
    157c:	e50b0018 	str	r0, [fp, #-24]	@ 0xffffffe8
    1580:	e51b3018 	ldr	r3, [fp, #-24]	@ 0xffffffe8
    1584:	e2833007 	add	r3, r3, #7
    1588:	e1a031a3 	lsr	r3, r3, #3
    158c:	e2833001 	add	r3, r3, #1
    1590:	e50b3010 	str	r3, [fp, #-16]
    1594:	e59f3134 	ldr	r3, [pc, #308]	@ 16d0 <malloc+0x160>
    1598:	e5933000 	ldr	r3, [r3]
    159c:	e50b300c 	str	r3, [fp, #-12]
    15a0:	e51b300c 	ldr	r3, [fp, #-12]
    15a4:	e3530000 	cmp	r3, #0
    15a8:	1a00000b 	bne	15dc <malloc+0x6c>
    15ac:	e59f3120 	ldr	r3, [pc, #288]	@ 16d4 <malloc+0x164>
    15b0:	e50b300c 	str	r3, [fp, #-12]
    15b4:	e59f2114 	ldr	r2, [pc, #276]	@ 16d0 <malloc+0x160>
    15b8:	e51b300c 	ldr	r3, [fp, #-12]
    15bc:	e5823000 	str	r3, [r2]
    15c0:	e59f3108 	ldr	r3, [pc, #264]	@ 16d0 <malloc+0x160>
    15c4:	e5933000 	ldr	r3, [r3]
    15c8:	e59f2104 	ldr	r2, [pc, #260]	@ 16d4 <malloc+0x164>
    15cc:	e5823000 	str	r3, [r2]
    15d0:	e59f30fc 	ldr	r3, [pc, #252]	@ 16d4 <malloc+0x164>
    ...
    1660:	e59f2068 	ldr	r2, [pc, #104]	@ 16d0 <malloc+0x160>
    1664:	e51b300c 	ldr	r3, [fp, #-12]
    1668:	e5823000 	str	r3, [r2]
    166c:	e51b3008 	ldr	r3, [fp, #-8]
    1670:	e2833008 	add	r3, r3, #8
    1674:	ea000012 	b	16c4 <malloc+0x154>
    1678:	e59f3050 	ldr	r3, [pc, #80]	@ 16d0 <malloc+0x160>
    167c:	e5933000 	ldr	r3, [r3]
    1680:	e51b2008 	ldr	r2, [fp, #-8]
    1684:	e1520003 	cmp	r2, r3
    1688:	1a000007 	bne	16ac <malloc+0x13c>
    168c:	e51b0010 	ldr	r0, [fp, #-16]
    1690:	ebffff94 	bl	14e8 <morecore>
    1694:	e50b0008 	str	r0, [fp, #-8]
    1698:	e51b3008 	ldr	r3, [fp, #-8]
    169c:	e3530000 	cmp	r3, #0
    16a0:	1a000001 	bne	16ac <malloc+0x13c>
    16a4:	e3a03000 	mov	r3, #0
    16a8:	ea000005 	b	16c4 <malloc+0x154>
    ...
    16c0:	eaffffc8 	b	15e8 <malloc+0x78>
    16c4:	e1a00003 	mov	r0, r3
    16c8:	e24bd004 	sub	sp, fp, #4
    16cc:	e8bd8800 	pop	{fp, pc}
    16d0:	00001814 	.word	0x00001814
    16d4:	0000180c 	.word	0x0000180c

000016d8 <__udivsi3>:
    16d8:	e2512001 	subs	r2, r1, #1
    16dc:	012fff1e 	bxeq	lr
    16e0:	3a000036 	bcc	17c0 <__udivsi3+0xe8>
    16e4:	e1500001 	cmp	r0, r1
    16e8:	9a000022 	bls	1778 <__udivsi3+0xa0>
    16ec:	e1110002 	tst	r1, r2
    16f0:	0a000023 	beq	1784 <__udivsi3+0xac>
    16f4:	e311020e 	tst	r1, #-536870912	@ 0xe0000000
    16f8:	01a01181 	lsleq	r1, r1, #3
    16fc:	03a03008 	moveq	r3, #8
    1700:	13a03001 	movne	r3, #1
    1704:	e3510201 	cmp	r1, #268435456	@ 0x10000000
    1708:	31510000 	cmpcc	r1, r0
    170c:	31a01201 	lslcc	r1, r1, #4
    1710:	31a03203 	lslcc	r3, r3, #4
    1714:	3afffffa 	bcc	1704 <__udivsi3+0x2c>
    1718:	e3510102 	cmp	r1, #-2147483648	@ 0x80000000
    171c:	31510000 	cmpcc	r1, r0
    1720:	31a01081 	lslcc	r1, r1, #1
    1724:	31a03083 	lslcc	r3, r3, #1
    1728:	3afffffa 	bcc	1718 <__udivsi3+0x40>
    172c:	e3a02000 	mov	r2, #0
    1730:	e1500001 	cmp	r0, r1
    1734:	20400001 	subcs	r0, r0, r1
    1738:	21822003 	orrcs	r2, r2, r3
    173c:	e15000a1 	cmp	r0, r1, lsr #1
    1740:	204000a1 	subcs	r0, r0, r1, lsr #1
    1744:	218220a3 	orrcs	r2, r2, r3, lsr #1
    1748:	e1500121 	cmp	r0, r1, lsr #2
    174c:	20400121 	subcs	r0, r0, r1, lsr #2
    1750:	21822123 	orrcs	r2, r2, r3, lsr #2
    1754:	e15001a1 	cmp	r0, r1, lsr #3
    1758:	204001a1 	subcs	r0, r0, r1, lsr #3
    175c:	218221a3 	orrcs	r2, r2, r3, lsr #3
    1760:	e3500000 	cmp	r0, #0
    1764:	11b03223 	lsrsne	r3, r3, #4
    1768:	11a01221 	lsrne	r1, r1, #4
    176c:	1affffef 	bne	1730 <__udivsi3+0x58>
    1770:	e1a00002 	mov	r0, r2
    1774:	e12fff1e 	bx	lr
    1778:	03a00001 	moveq	r0, #1
    177c:	13a00000 	movne	r0, #0
    1780:	e12fff1e 	bx	lr
    1784:	e3510801 	cmp	r1, #65536	@ 0x10000
    1788:	21a01821 	lsrcs	r1, r1, #16
    178c:	23a02010 	movcs	r2, #16
    1790:	33a02000 	movcc	r2, #0
    1794:	e3510c01 	cmp	r1, #256	@ 0x100
    1798:	21a01421 	lsrcs	r1, r1, #8
    179c:	22822008 	addcs	r2, r2, #8
    17a0:	e3510010 	cmp	r1, #16
    17a4:	21a01221 	lsrcs	r1, r1, #4
    17a8:	22822004 	addcs	r2, r2, #4
    17ac:	e3510004 	cmp	r1, #4
    17b0:	82822003 	addhi	r2, r2, #3
    17b4:	908220a1 	addls	r2, r2, r1, lsr #1
    17b8:	e1a00230 	lsr	r0, r0, r2
    17bc:	e12fff1e 	bx	lr
    17c0:	e3500000 	cmp	r0, #0
    17c4:	13e00000 	mvnne	r0, #0
    17c8:	ea000007 	b	17ec <__aeabi_idiv0>

000017cc <__aeabi_uidivmod>:
    17cc:	e3510000 	cmp	r1, #0
    17d0:	0afffffa 	beq	17c0 <__udivsi3+0xe8>
    17d4:	e92d4003 	push	{r0, r1, lr}
    17d8:	ebffffbe 	bl	16d8 <__udivsi3>
    17dc:	e8bd4006 	pop	{r1, r2, lr}
    17e0:	e0030092 	mul	r3, r2, r0
    17e4:	e0411003 	sub	r1, r1, r3
    17e8:	e12fff1e 	bx	lr

000017ec <__aeabi_idiv0>:
    17ec:	e12fff1e 	bx	lr
